 ...
 */var Zy;function Bh(){if(Zy)return gi;Zy=1;var T=Symbol.for("react.transitional.element"),P=Symbol.for("react.fragment");function M(m,I,z){var Z=null;if(z!==void 0&&(Z=""+z),I.key!==void 0&&(Z=""+I.key),"key"in I){z={};for(var Rn in I)Rn!=="key"&&(z[Rn]=I[Rn])}else z=I;return I=z.ref,{$$typeof:T,type:m,key:Z,ref:I!==void 0?I:null,props:z}}return gi.Fragment=P,gi.jsx=M,gi.jsxs=M,gi}var Qy;function Mh(){return Qy||(Qy=1,Zu.exports=Bh()),Zu.exports}var p=Mh(),Qu={exports:{}},x={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
...
隠す　お気に入りの一輪
舞い上がる風に託すよ
いつまでも愛に満ちた日々を`}],zh=({song:T,onClose:P})=>{if(!T)return null;const M=z=>z==="t"?"披露あり":z==="f"?"未披露":"不明",m=T.album.filter(z=>z.includes("[")&&z.includes("]")),I=z=>{const Z=z.match(/(.*?)\{/);return Z&&Z[1]?Z[1]:z};return p.jsx("div",{className:"modal-overlay",onClick:P,children:p.jsxs("div",{className:"modal-content",onClick:z=>z.stopPropagation(),children:[p.jsx("h2",{children:T.title}),p.jsxs("p",{children:[p.jsx("strong",{children:"作詞者:"})," ",p.jsx("span",{className:"modal-item-value",children:T.lyricist})]}),"   ",p.jsxs("p",{children:[p.jsx("strong",{children:"作曲者:"})," ",p.jsx("span",{className:"modal-item-value",children:T.composer})]})," ",T.arranger&&p.jsxs("p",{children:[p.jsx("strong",{children:"編曲者:"})," ",p.jsx("span",{className:"modal-item-value",children:T.arranger})]}),T.brassarrange&&p.jsxs("p",{children:[p.jsx("strong",{children:"ブラスアレンジ:"})," ",p.jsx("span",{className:"modal-item-value",children:T.brassarrange})]}),T.produce&&p.jsxs("p",{children:[p.jsx("strong",{children:"プロデュース:"})," ",p.jsx("span",{className:"modal-item-value",children:T.produce})]}),T.stringsarrange&&p.jsxs("p",{children:[p.jsx("strong",{children:"ストリングスアレンジ:"})," ",p.jsx("span",{className:"modal-item-value",children:T.stringsarrange})]}),T.translate&&p.jsxs("p",{children:[p.jsx("strong",{children:"英訳詞:"})," ",p.jsx("span",{className:"modal-item-value",children:T.translate})]}),p.jsxs("p",{children:[p.jsx("strong",{children:"ユニット:"})," ",p.jsx("span",{className:"modal-item-value",children:T.singer||"WEST."})]})," ",p.jsxs("p",{children:[p.jsx("strong",{children:"発売日:"})," ",p.jsx("span",{className:"modal-item-value",children:T.date})]}),"      ",T.tiup&&p.jsxs("p",{children:[p.jsx("strong",{children:"タイアップ:"})," ",p.jsx("span",{className:"modal-item-value",children:T.tiup})]}),p.jsx("p",{children:p.jsx("strong",{children:"収録シングル/アルバム:"})}),p.jsxs("ul",{children:[m.map((z,Z)=>p.jsx("li",{children:p.jsx("span",{className:"modal-item-value",children:z})},Z)),m.length===0&&p.jsx("li",{children:p.jsx("span",{className:"modal-item-value",children:"[]付きの収録はありません"})})]}),p.jsxs("p",{children:[p.jsx("strong",{children:"披露情報:"})," ",p.jsx("span",{className:"modal-item-value",children:M(T.announce)})]})," ",T.lyrics&&p.jsxs("div",{className:"lyrics-section",children:[" ",p.jsx("h3",{children:"歌詞"}),p.jsx("p",{className:"modal-lyrics-text",children:T.lyrics})," "]}),T.performances&&T.performances.length>0&&p.jsxs(p.Fragment,{children:[p.jsx("p",{children:p.jsx("strong",{children:"披露公演:"})}),p.jsx("ul",{className:"performance-list",children:T.performances.map((z,Z)=>p.jsx("li",{children:p.jsx("span",{className:"modal-item-value",children:I(z)})},Z))})]}),p.jsx("button",{onClick:P,className:"modal-close-button",children:"閉じる"})]})})},Uh=["タイトル","作詞者","作曲者","編曲者","歌詞","収録","披露","ユニット","タイアップ","セトリ"];function Ih(){const[T,P]=Na.useState(""),[M,m]=Na.useState("タイトル"),[I,z]=Na.useState("name_asc"),[Z,Rn]=Na.useState(null),[Y,b]=Na.useState(!1);Na.useEffect(()=>{P("")},[M]);const N=["ええじゃないか","ええじゃないか[初回盤]","ええじゃないか[MY BEST CD盤]","ええじゃないか[通常盤]","go WEST よーいドン！","go WEST よーいドン！[初回盤]","go WEST よーいドン！[通常盤]","ジパング・おおきに大作戦/夢を抱きしめて","ジパング・おおきに大作戦/夢を抱きしめて[初回A]","ジパング・おおきに大作戦/夢を抱きしめて[初回B]","ジパング・おおきに大作戦/夢を抱きしめて[初回C]","ジパング・おおきに大作戦/夢を抱きしめて[通常盤]","ズンドコ パラダイス","ズンドコ パラダイス[初回A]","ズンドコ パラダイス[初回B]","ズンドコ パラダイス[通常盤]","パリピポ","パリピポ[初回盤]","パリピポ[通常盤]","バリ ハピ","バリ ハピ[初回A]","バリ ハピ[初回B]","バリ ハピ[通常盤]","ラッキィィィィィィィ7","ラッキィィィィィィィ7[初回盤]","ラッキィィィィィィィ7[通常盤]","逆転Winner","逆転Winner[初回A]","逆転Winner[初回B]","逆転Winner[通常盤]","人生は素晴らしい","人生は素晴らしい[初回A]","人生は素晴らしい[初回B]","人生は素晴らしい[通常盤]","なうぇすと","なうぇすと[初回盤]","なうぇすと[通常盤]","おーさか☆愛・EYE・哀/Ya! Hot! Hot!","おーさか☆愛・EYE・哀/Ya! Hot! Hot![初回A]","おーさか☆愛・EYE・哀/Ya! Hot! Hot![初回B]","おーさか☆愛・EYE・哀/Ya! Hot! Hot![通常盤]","僕ら今日も生きている/考えるな、燃えろ!!","僕ら今日も生きている/考えるな、燃えろ!![初回A]","僕ら今日も生きている/考えるな、燃えろ!![初回B]","僕ら今日も生きている/考えるな、燃えろ!![通常盤]","WESTival","WESTival[初回盤]","WESTival[通常盤]","プリンシパルの君へ/ドラゴンドッグ","プリンシパルの君へ/ドラゴンドッグ[初回A]","プリンシパルの君へ/ドラゴンドッグ[初回B]","プリンシパルの君へ/ドラゴンドッグ[通常盤]","スタートダッシュ!","スタートダッシュ![初回A]","スタートダッシュ![初回B]","スタートダッシュ![通常盤]","WESTV！","WESTV！[初回盤]","WESTV！[通常盤]","ホメチギリスト/傷だらけの愛","ホメチギリスト/傷だらけの愛[初回A]","ホメチギリスト/傷だらけの愛[初回B]","ホメチギリスト/傷だらけの愛[通常盤]","アメノチハレ","アメノチハレ[初回A]","アメノチハレ[初回B]","アメノチハレ[通常盤]","Big Shot!!","Big Shot!![初回A]","Big Shot!![初回B]","Big Shot!![通常盤]","W trouble","W trouble[初回A]","W trouble[初回B]","W trouble[通常盤]","W trouble[通販盤]","証拠","証拠[初回A]","証拠[初回B]","証拠[通常盤]","週刊うまくいく曜日","週刊うまくいく曜日[初回A]","週刊うまくいく曜日[初回B]","週刊うまくいく曜日[通常盤]","rainboW","rainboW[初回A]","rainboW[初回B]","rainboW[通常盤]","rainboW[通販盤]","サムシング・ニュー","サムシング・ニュー[初回A]","サムシング・ニュー[初回B]","サムシング・ニュー[通常盤]","でっかい愛/喜努愛楽","でっかい愛/喜努愛楽[初回A]","でっかい愛/喜努愛楽[初回B]","でっかい愛/喜努愛楽[通常盤]","黎明/進むしかねぇ","黎明/進むしかねぇ[初回A]","黎明/進むしかねぇ[初回B]","黎明/進むしかねぇ[通常盤]","Mixed Juice","Mixed Juice[初回A]","Mixed Juice[初回B]","Mixed Juice[通常盤]","星の雨","星の雨[初回A]","星の雨[初回B]","星の雨[通常盤]","星の雨[通販盤]","POWER","POWER[初回A]","POWER[初回B]","POWER[通常盤]","POWER[通販盤]","しあわせの花","しあわせの花[初回A]","しあわせの花[初回B]","しあわせの花[通常盤]","しあわせの花[通販盤]","絶体絶命 / Beautiful / AS ONE","絶体絶命 / Beautiful / AS ONE[初回A]","絶体絶命 / Beautiful / AS ONE[初回B]","絶体絶命 / Beautiful / AS ONE[初回C]","絶体絶命 / Beautiful / AS ONE[通常盤]","AWARD","AWARD[初回A]","AWARD[初回B]","AWARD[通常盤]","ハート / FATE","ハート / FATE[初回A]","ハート / FATE[初回B]","ハート / FATE[通常盤]","ハート / FATE[通販盤]","まぁいっか！","まぁいっか！[初回A]","まぁいっか！[初回B]","まぁいっか！[通常盤]","A.H.O. -Audio Hang Out-","A.H.O. -Audio Hang Out-[初回A]","A.H.O. -Audio Hang Out-[初回B]","A.H.O. -Audio Hang Out-[通常盤]","ウェッサイソウル！ / BIG LOVE SONG","ウェッサイソウル！ / BIG LOVE SONG[初回A]","ウェッサイソウル！ / BIG LOVE SONG[初回B]","ウェッサイソウル！ / BIG LOVE SONG[通常盤]"],un=["なにわともあれ、ほんまにありがとう！","一発めぇぇぇぇぇぇぇ！","一発めぇぇぇぇぇぇぇ！(各会場オーラス)","一発めぇぇぇぇぇぇぇ！(大阪オーラス)","パリピポ","パリピポ(各会場オーラス)","パリピポ(兵庫オーラス)","ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟)","ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟のオーラス)","ラッキィィィィィィィ7(大阪,宮城)","ラッキィィィィィィィ7(大阪オーラス)","ラッキィィィィィィィ7(宮城オーラス)","24(ニシ)から感謝届けます♡","24(ニシ)から感謝届けます♡(オーラス)","なうぇすと(〜横浜3日目)","なうぇすと(横浜4日目〜,福井,福岡,宮城,愛知,静岡,大阪,北海道,広島)","なうぇすと(各会場オーラス)","なうぇすと(広島オーラス)","WESTival","WESTival(各会場オーラス)","WESTival(北海道オーラス)","WESTV!","WESTV!(各会場オーラス)","WESTV!(北海道オーラス)","W trouble12/11","W trouble12/12昼,12/13夜","W trouble12/12夜,12/13昼","rainboW(北海道)","rainboW(宮城,愛知,新潟,埼玉,熊本)","rainboW(円盤)","Mixed Juice(静岡3/20,熊本3/26,宮城4/1,宮城4/2,愛知4/10,愛知4/15,横浜4/28,北海道6/10)","Mixed Juice(静岡3/21,熊本3/27,宮城4/3,愛知4/9,大阪4/16,大阪4/17,横浜4/27昼,横浜4/29昼,横浜4/30,城ホ5/5昼,新潟5/15昼,北海道6/11)","Mixed Juice(横浜4/27夜,横浜5/1夜,城ホ5/5夜,新潟5/15夜,北海道6/12夜)","Mixed Juice(横浜4/29夜,横浜5/1昼,城ホ5/4,新潟5/16,北海道6/12昼)","Mixed Juice(北海道オーラス)","TO BE KANSAI COLOR-翔べ関西から-(大阪)","TO BE KANSAI COLOR-翔べ関西から-(名古屋)","TO BE KANSAI COLOR-翔べ関西から-(東京)","TO BE KANSAI COLOR-翔べ関西から-(東京オーラス)","POWER(宮城)","POWER(横浜,福岡,新潟,静岡,大阪,北海道,愛知)","POWER(愛知オーラス)","AWARD(大阪)","AWARD(新潟)","AWARD(宮城)","AWARD(愛知)","AWARD(横浜,静岡,福岡,広島,北海道)","AWARD(北海道オーラス)","DOME TOUR AWARD(大阪,福岡)","DOME TOUR AWARD(東京)","DOME TOUR AWARD(東京オーラス)","A.H.O. -Audio Hang Out-(香川,大阪,福岡,宮城4/12)","A.H.O. -Audio Hang Out-(宮城4/13,北海道,横浜,新潟,静岡,愛知)","A.H.O. -Audio Hang Out-A.H.O(愛知オーラス)","メトロック2022(大阪)","LOVE MUSIC FESTIVAL2022","サマソニ2023(大阪,東京)","めざまし30周年フェス(東京)","メトロック2024(東京)","サマソニ2024(大阪,東京)","a-nation2024","KOYABU SONIC2024","CDTV ライブ！ ライブ！大感謝祭2024","CDTV ライブ！ ライブ！春の大感謝祭2025","メトロック2025(東京)","ファンクラブ限定動画(改名発表)","ファンクラブ限定動画(ゴールデンウィークはWEST. WEEK!<Special Performance>)","Johnny's World Happy LIVE with YOU(3/29)","Johnny's World Happy LIVE with YOU(6/18)","ジャニーズWEST デビュー記念イベント デビューしてもええじゃないか ～バンザイ!! その先の一等賞へ～","皆様のおかげSummer Carnival!","５周ねんやねん♪よろしゅうねん♪","Special Studio Recording(証拠[初回B])","Johnny's DREAM IsLAND 2020→2025 〜大好きなこの街から〜 大阪松竹座 ジャニーズWEST公演","SPECIAL LIVE(サムシング・ニュー[初回B])","スペシャルセッション(しあわせの花[初回B])","新グループ名発表します","【WESTube生配信SP】結成10周年やねぇぇぇぇぇぇぇん","【WESTube生配信】4.23デビュー10周年やねぇぇぇぇぇぇぇんSP","【年越し生配信2024→2025】デビュー10周年ありがとう⭐️&登録者数100万人達成記念SP🎉 ✨100/100✨","7周年生配信イベント「虹会」","8周年生配信トーク＆ライブ「虹会」","9周年生配信トーク＆ライブ「虹会」","10周年生配信トーク＆ライブ「虹会」","11周年生配信トーク＆ライブ「虹会」","WEST. 10th Anniversary Live “W”","WEST. 10th Anniversary Live “W”-Film edition-","なにわ侍　ハローTOKYO!!","台風n Dreamer","なにわ侍 団五郎一座","WEST. 10th Anniversary 大阪松竹座公演(昼)","WEST. 10th Anniversary 大阪松竹座公演(夜)","WEST. 10th Anniversary 大阪松竹座公演(千穐楽)"],an=Array.from(new Set(ar.map(W=>W.singer).filter(Boolean))),wn=[{label:"⇅ 名前順(あ→わ)",value:"name_asc"},{label:"⇅ 名前順(わ→あ)",value:"name_desc"},{label:"⇅ 古い曲順",value:"date_asc"},{label:"⇅ 新しい曲順",value:"date_desc"}],Nn=W=>{const L=W.match(/(.*?)\{(\d+)\}/);return L&&L[1]&&L[2]?{name:L[1],order:parseInt(L[2],10)}:null},Xn=ar.flatMap(W=>!W.performances||W.performances.length===0?[{originalSong:W,performanceDetail:null,id:`song-${W.id}`}]:W.performances.map(L=>{const sn=Nn(L);return sn?{originalSong:W,performanceDetail:sn,id:`${W.id}-${sn.name}-${sn.order}`}:(console.warn(`Warning: Could not parse performance entry: "${L}" for song: "${W.title}"`),{originalSong:W,performanceDetail:null,id:`song-${W.id}-unparsed-${L.replace(/[^a-zA-Z0-9]/g,"")}`})}).filter(Boolean));let En=[];M==="セトリ"?(En=Xn.filter(W=>W.performanceDetail?T===""?(console.log("DEBUG: セトリモードで検索値が空です。このアイテムは除外されます。",W.originalSong.title),!1):T===""||W.performanceDetail.name===T:!1),En.sort((W,L)=>{let sn=W.performanceDetail?W.performanceDetail.order:1/0,fn=L.performanceDetail?L.performanceDetail.order:1/0;return sn-fn})):(En=ar.filter(W=>{const L=T.toLowerCase(),sn=fn=>fn?fn.toLowerCase().replace(/[！♪？「」（）、。、～…]/g,"").replace(/[\s　]+/g," ").trim():"";return M==="タイトル"?W.title.toLowerCase().includes(L):M==="作詞者"?W.lyricist.toLowerCase().includes(L):M==="作曲者"?W.composer.toLowerCase().includes(L):M==="編曲者"?W.arranger.toLowerCase().includes(L):M==="歌詞"?sn(W.lyrics).includes(sn(L)):M==="収録"?T===""||W.album.includes(T):M==="披露"?T==="披露あり"?W.announce=="t":T==="未披露"?W.announce==="f":!0:M==="ユニット"?T===""||W.singer===T:M==="タイアップ"?T==="あり"?W.tiup&&W.tiup.trim()!=="":T==="なし"?!W.tiup||W.tiup.trim()==="":!0:!0}),En.sort((W,L)=>{const sn=fn=>{const Wn=fn.charAt(0);return Wn.match(/^[\u3040-\u30FF]/)?0:Wn.match(/^[a-zA-Z]/)?1:2};if(I==="name_asc"||I==="name_desc"){const fn=sn(W.titleKana),Wn=sn(L.titleKana);return fn!==Wn?I==="name_asc"?fn-Wn:Wn-fn:I==="name_asc"?W.titleKana.localeCompare(L.titleKana,"ja",{sensitivity:"base"}):L.titleKana.localeCompare(W.titleKana,"ja",{sensitivity:"base"})}return I==="date_asc"?new Date(W.date)-new Date(L.date):I==="date_desc"?new Date(L.date)-new Date(W.date):0}));const Se=En,he=W=>{Rn(W),b(!0)},Dn=()=>{b(!1),Rn(null)};return p.jsxs("div",{className:"container",children:[p.jsx("h1",{children:"WEST. 楽曲リスト"}),p.jsxs("div",{className:"controls",children:[p.jsx("select",{value:M,onChange:W=>m(W.target.value),children:Uh.map(W=>p.jsx("option",{value:W,children:W},W))}),M==="収録"?p.jsxs("select",{value:T,onChange:W=>P(W.target.value),children:[p.jsx("option",{value:"",children:"すべての収録"}),N.map(W=>p.jsx("option",{value:W,children:W},W))]}):M==="ユニット"?p.jsxs("select",{value:T,onChange:W=>P(W.target.value),children:[p.jsx("option",{value:"",children:"すべてのユニット"}),an.map(W=>p.jsx("option",{value:W,children:W},W))]}):M==="披露"?p.jsxs("select",{value:T,onChange:W=>P(W.target.value),children:[p.jsx("option",{value:"",children:"すべての曲"}),p.jsx("option",{value:"披露あり",children:"披露あり"}),p.jsx("option",{value:"未披露",children:"未披露"})]}):M==="タイアップ"?p.jsxs("select",{value:T,onChange:W=>P(W.target.value),children:[p.jsx("option",{value:"",children:"すべて"})," ",p.jsx("option",{value:"あり",children:"あり"}),p.jsx("option",{value:"なし",children:"なし"})]}):M==="セトリ"?p.jsxs("select",{value:T,onChange:W=>P(W.target.value),children:[p.jsx("option",{value:"",disabled:!0,selected:!0,children:"公演を選択してください"}),un.map(W=>p.jsx("option",{value:W,children:W},W))]}):M==="歌詞"?p.jsx("input",{type:"text",placeholder:"歌詞で検索...",value:T,onChange:W=>P(W.target.value)}):p.jsx("input",{type:"text",placeholder:`${M}で検索...`,value:T,onChange:W=>P(W.target.value)}),p.jsx("select",{value:I,onChange:W=>z(W.target.value),children:wn.map(W=>p.jsx("option",{value:W.value,children:W.label},W.value))})]}),p.jsxs("div",{style:{marginBottom:"0.5rem",fontSize:"0.9rem"},children:[Se.length," 件の曲が見つかりました"]}),p.jsx("div",{className:"song-list-wrapper",children:p.jsxs("div",{className:M==="セトリ"&&T!==""?"song-list show-performance-cols":"song-list",children:[p.jsxs("div",{className:"song-header",children:[p.jsx("span",{children:"タイトル"}),p.jsx("span",{children:"作詞者"}),p.jsx("span",{children:"作曲者"}),p.jsx("span",{children:"初収録"}),p.jsx("span",{children:"発売日"})]}),Se.map(W=>p.jsxs("div",{className:"song-card",onClick:()=>he(M==="セトリ"?W.originalSong:W),children:[p.jsx("span",{className:"song-title",children:M==="セトリ"?W.originalSong.title:W.title}),p.jsx("span",{children:M==="セトリ"?W.originalSong.lyricist:W.lyricist}),p.jsx("span",{children:M==="セトリ"?W.originalSong.composer:W.composer}),p.jsx("span",{children:M==="セトリ"?W.originalSong.album[0]:W.album[0]}),p.jsx("span",{className:"song-date",children:M==="セトリ"?W.originalSong.date:W.date})]},W.id))]})}),Y&&Z&&p.jsx(zh,{song:Z,onClose:Dn})]})}kh.createRoot(document.getElementById("root")).render(p.jsx(Na.StrictMode,{children:p.jsx(Ih,{})}));
