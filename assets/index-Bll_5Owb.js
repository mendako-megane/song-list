(function(){const P=document.createElement("link").relList;if(P&&P.supports&&P.supports("modulepreload"))return;for(const Y of document.querySelectorAll('link[rel="modulepreload"]'))g(Y);new MutationObserver(Y=>{for(const V of Y)if(V.type==="childList")for(const sn of V.addedNodes)sn.tagName==="LINK"&&sn.rel==="modulepreload"&&g(sn)}).observe(document,{childList:!0,subtree:!0});function U(Y){const V={};return Y.integrity&&(V.integrity=Y.integrity),Y.referrerPolicy&&(V.referrerPolicy=Y.referrerPolicy),Y.crossOrigin==="use-credentials"?V.credentials="include":Y.crossOrigin==="anonymous"?V.credentials="omit":V.credentials="same-origin",V}function g(Y){if(Y.ep)return;Y.ep=!0;const V=U(Y);fetch(Y.href,V)}})();var Qu={exports:{}},Al={};/**
 * @license React
 ...
 */var Zy;function Rd(){if(Zy)return Al;Zy=1;var O=Symbol.for("react.transitional.element"),P=Symbol.for("react.fragment");function U(g,Y,V){var sn=null;if(V!==void 0&&(sn=""+V),Y.key!==void 0&&(sn=""+Y.key),"key"in Y){V={};for(var On in Y)On!=="key"&&(V[On]=Y[On])}else V=Y;return Y=V.ref,{$$typeof:O,type:g,key:sn,ref:Y!==void 0?Y:null,props:V}}return Al.Fragment=P,Al.jsx=U,Al.jsxs=U,Al}var Qy;function Dd(){return Qy||(Qy=1,Qu.exports=Rd()),Qu.exports}var W=Dd(),Fu={exports:{}},I={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Fy;function Yd(){if(Fy)return I;Fy=1;var O=Symbol.for("react.transitional.element"),P=Symbol.for("react.portal"),U=Symbol.for("react.fragment"),g=Symbol.for("react.strict_mode"),Y=Symbol.for("react.profiler"),V=Symbol.for("react.consumer"),sn=Symbol.for("react.context"),On=Symbol.for("react.forward_ref"),M=Symbol.for("react.suspense"),v=Symbol.for("react.memo"),L=Symbol.for("react.lazy"),on=Symbol.iterator;function en(c){return c===null||typeof c!="object"?null:(c=on&&c[on]||c["@@iterator"],typeof c=="function"?c:null)}var Wn={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},Dn=Object.assign,Vn={};function B(c,T,w){this.props=c,this.context=T,this.refs=Vn,this.updater=w||Wn}B.prototype.isReactComponent={},B.prototype.setState=function(c,T){if(typeof c!="object"&&typeof c!="function"&&c!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,c,T,"setState")},B.prototype.forceUpdate=function(c){this.updater.enqueueForceUpdate(this,c,"forceUpdate")};function Yn(){}Yn.prototype=B.prototype;function oe(c,T,w){this.props=c,this.context=T,this.refs=Vn,this.updater=w||Wn}var dn=oe.prototype=new Yn;dn.constructor=oe,Dn(dn,B.prototype),dn.isPureReactComponent=!0;var pn=Array.isArray,X={H:null,A:null,T:null,S:null,V:null},qn=Object.prototype.hasOwnProperty;function Xn(c,T,w,p,N,Z){return w=Z.ref,{$$typeof:O,type:c,key:T,ref:w!==void 0?w:null,props:Z}}function Zn(c,T){return Xn(c.type,T,void 0,void 0,void 0,c.props)}function Ee(c){return typeof c=="object"&&c!==null&&c.$$typeof===O}function Na(c){var T={"=":"=0",":":"=2"};return"$"+c.replace(/[=:]/g,function(w){return T[w]})}var He=/\/+/g;function Kn(c,T){return typeof c=="object"&&c!==null&&c.key!=null?Na(""+c.key):T.toString(36)}function ha(){}function da(c){switch(c.status){case"fulfilled":return c.value;case"rejected":throw c.reason;default:switch(typeof c.status=="string"?c.then(ha,ha):(c.status="pending",c.then(function(T){c.status==="pending"&&(c.status="fulfilled",c.value=T)},function(T){c.status==="pending"&&(c.status="rejected",c.reason=T)})),c.status){case"fulfilled":return c.value;case"rejected":throw c.reason}}throw c}function Gn(c,T,w,p,N){var Z=typeof c;(Z==="undefined"||Z==="boolean")&&(c=null);var z=!1;if(c===null)z=!0;else switch(Z){case"bigint":case"string":case"number":z=!0;break;case"object":switch(c.$$typeof){case O:case P:z=!0;break;case L:return z=c._init,Gn(z(c._payload),T,w,p,N)}}if(z)return N=N(c),z=p===""?"."+Kn(c,0):p,pn(N)?(w="",z!=null&&(w=z.replace(He,"$&/")+"/"),Gn(N,T,w,"",function(Je){return Je})):N!=null&&(Ee(N)&&(N=Zn(N,w+(N.key==null||c&&c.key===N.key?"":(""+N.key).replace(He,"$&/")+"/")+z)),T.push(N)),1;z=0;var Qn=p===""?".":p+":";if(pn(c))for(var yn=0;yn<c.length;yn++)p=c[yn],Z=Qn+Kn(p,yn),z+=Gn(p,T,w,Z,N);else if(yn=en(c),typeof yn=="function")for(c=yn.call(c),yn=0;!(p=c.next()).done;)p=p.value,Z=Qn+Kn(p,yn++),z+=Gn(p,T,w,Z,N);else if(Z==="object"){if(typeof c.then=="function")return Gn(da(c),T,w,p,N);throw T=String(c),Error("Objects are not valid as a React child (found: "+(T==="[object Object]"?"object with keys {"+Object.keys(c).join(", ")+"}":T)+"). If you meant to render a collection of children, use an array instead.")}return z}function S(c,T,w){if(c==null)return c;var p=[],N=0;return Gn(c,p,"","",function(Z){return T.call(w,Z,N++)}),p}function H(c){if(c._status===-1){var T=c._result;T=T(),T.then(function(w){(c._status===0||c._status===-1)&&(c._status=1,c._result=w)},function(w){(c._status===0||c._status===-1)&&(c._status=2,c._result=w)}),c._status===-1&&(c._status=0,c._result=T)}if(c._status===1)return c._result.default;throw c._result}var k=typeof reportError=="function"?reportError:function(c){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var T=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof c=="object"&&c!==null&&typeof c.message=="string"?String(c.message):String(c),error:c});if(!window.dispatchEvent(T))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",c);return}console.error(c)};function un(){}return I.Children={map:S,forEach:function(c,T,w){S(c,function(){T.apply(this,arguments)},w)},count:function(c){var T=0;return S(c,function(){T++}),T},toArray:function(c){return S(c,function(T){return T})||[]},only:function(c){if(!Ee(c))throw Error("React.Children.only expected to receive a single React element child.");return c}},I.Component=B,I.Fragment=U,I.Profiler=Y,I.PureComponent=oe,I.StrictMode=g,I.Suspense=M,I.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=X,I.__COMPILER_RUNTIME={__proto__:null,c:function(c){return X.H.useMemoCache(c)}},I.cache=function(c){return function(){return c.apply(null,arguments)}},I.cloneElement=function(c,T,w){if(c==null)throw Error("The argument must be a React element, but you passed "+c+".");var p=Dn({},c.props),N=c.key,Z=void 0;if(T!=null)for(z in T.ref!==void 0&&(Z=void 0),T.key!==void 0&&(N=""+T.key),T)!qn.call(T,z)||z==="key"||z==="__self"||z==="__source"||z==="ref"&&T.ref===void 0||(p[z]=T[z]);var z=arguments.length-2;if(z===1)p.children=w;else if(1<z){for(var Qn=Array(z),yn=0;yn<z;yn++)Qn[yn]=arguments[yn+2];p.children=Qn}return Xn(c.type,N,void 0,void 0,Z,p)},I.createContext=function(c){return c={$$typeof:sn,_currentValue:c,_currentValue2:c,_threadCount:0,Provider:null,Consumer:null},c.Provider=c,c.Consumer={$$typeof:V,_context:c},c},I.createElement=function(c,T,w){var p,N={},Z=null;if(T!=null)for(p in T.key!==void 0&&(Z=""+T.key),T)qn.call(T,p)&&p!=="key"&&p!=="__self"&&p!=="__source"&&(N[p]=T[p]);var z=arguments.length-2;if(z===1)N.children=w;else if(1<z){for(var Qn=Array(z),yn=0;yn<z;yn++)Qn[yn]=arguments[yn+2];N.children=Qn}if(c&&c.defaultProps)for(p in z=c.defaultProps,z)N[p]===void 0&&(N[p]=z[p]);return Xn(c,Z,void 0,void 0,null,N)},I.createRef=function(){return{current:null}},I.forwardRef=function(c){return{$$typeof:On,render:c}},I.isValidElement=Ee,I.lazy=function(c){return{$$typeof:L,_payload:{_status:-1,_result:c},_init:H}},I.memo=function(c,T){return{$$typeof:v,type:c,compare:T===void 0?null:T}},I.startTransition=function(c){var T=X.T,w={};X.T=w;try{var p=c(),N=X.S;N!==null&&N(w,p),typeof p=="object"&&p!==null&&typeof p.then=="function"&&p.then(un,k)}catch(Z){k(Z)}finally{X.T=T}},I.unstable_useCacheRefresh=function(){return X.H.useCacheRefresh()},I.use=function(c){return X.H.use(c)},I.useActionState=function(c,T,w){return X.H.useActionState(c,T,w)},I.useCallback=function(c,T){return X.H.useCallback(c,T)},I.useContext=function(c){return X.H.useContext(c)},I.useDebugValue=function(){},I.useDeferredValue=function(c,T){return X.H.useDeferredValue(c,T)},I.useEffect=function(c,T,w){var p=X.H;if(typeof w=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return p.useEffect(c,T)},I.useId=function(){return X.H.useId()},I.useImperativeHandle=function(c,T,w){return X.H.useImperativeHandle(c,T,w)},I.useInsertionEffect=function(c,T){return X.H.useInsertionEffect(c,T)},I.useLayoutEffect=function(c,T){return X.H.useLayoutEffect(c,T)},I.useMemo=function(c,T){return X.H.useMemo(c,T)},I.useOptimistic=function(c,T){return X.H.useOptimistic(c,T)},I.useReducer=function(c,T,w){return X.H.useReducer(c,T,w)},I.useRef=function(c){return X.H.useRef(c)},I.useState=function(c){return X.H.useState(c)},I.useSyncExternalStore=function(c,T,w){return X.H.useSyncExternalStore(c,T,w)},I.useTransition=function(){return X.H.useTransition()},I.version="19.1.0",I}var Py;function ar(){return Py||(Py=1,Fu.exports=Yd()),Fu.exports}var Ma=ar(),Pu={exports:{}},Sl={},$u={exports:{}},nr={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var $y;function Ld(){return $y||($y=1,function(O){function P(S,H){var k=S.length;S.push(H);n:for(;0<k;){var un=k-1>>>1,c=S[un];if(0<Y(c,H))S[un]=H,S[k]=c,k=un;else break n}}function U(S){return S.length===0?null:S[0]}function g(S){if(S.length===0)return null;var H=S[0],k=S.pop();if(k!==H){S[0]=k;n:for(var un=0,c=S.length,T=c>>>1;un<T;){var w=2*(un+1)-1,p=S[w],N=w+1,Z=S[N];if(0>Y(p,k))N<c&&0>Y(Z,p)?(S[un]=Z,S[N]=k,un=N):(S[un]=p,S[w]=k,un=w);else if(N<c&&0>Y(Z,k))S[un]=Z,S[N]=k,un=N;else break n}}return H}function Y(S,H){var k=S.sortIndex-H.sortIndex;return k!==0?k:S.id-H.id}if(O.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var V=performance;O.unstable_now=function(){return V.now()}}else{var sn=Date,On=sn.now();O.unstable_now=function(){return sn.now()-On}}var M=[],v=[],L=1,on=null,en=3,Wn=!1,Dn=!1,Vn=!1,B=!1,Yn=typeof setTimeout=="function"?setTimeout:null,oe=typeof clearTimeout=="function"?clearTimeout:null,dn=typeof setImmediate<"u"?setImmediate:null;function pn(S){for(var H=U(v);H!==null;){if(H.callback===null)g(v);else if(H.startTime<=S)g(v),H.sortIndex=H.expirationTime,P(M,H);else break;H=U(v)}}function X(S){if(Vn=!1,pn(S),!Dn)if(U(M)!==null)Dn=!0,qn||(qn=!0,Kn());else{var H=U(v);H!==null&&Gn(X,H.startTime-S)}}var qn=!1,Xn=-1,Zn=5,Ee=-1;function Na(){return B?!0:!(O.unstable_now()-Ee<Zn)}function He(){if(B=!1,qn){var S=O.unstable_now();Ee=S;var H=!0;try{n:{Dn=!1,Vn&&(Vn=!1,oe(Xn),Xn=-1),Wn=!0;var k=en;try{e:{for(pn(S),on=U(M);on!==null&&!(on.expirationTime>S&&Na());){var un=on.callback;if(typeof un=="function"){on.callback=null,en=on.priorityLevel;var c=un(on.expirationTime<=S);if(S=O.unstable_now(),typeof c=="function"){on.callback=c,pn(S),H=!0;break e}on===U(M)&&g(M),pn(S)}else g(M);on=U(M)}if(on!==null)H=!0;else{var T=U(v);T!==null&&Gn(X,T.startTime-S),H=!1}}break n}finally{on=null,en=k,Wn=!1}H=void 0}}finally{H?Kn():qn=!1}}}var Kn;if(typeof dn=="function")Kn=function(){dn(He)};else if(typeof MessageChannel<"u"){var ha=new MessageChannel,da=ha.port2;ha.port1.onmessage=He,Kn=function(){da.postMessage(null)}}else Kn=function(){Yn(He,0)};function Gn(S,H){Xn=Yn(function(){S(O.unstable_now())},H)}O.unstable_IdlePriority=5,O.unstable_ImmediatePriority=1,O.unstable_LowPriority=4,O.unstable_NormalPriority=3,O.unstable_Profiling=null,O.unstable_UserBlockingPriority=2,O.unstable_cancelCallback=function(S){S.callback=null},O.unstable_forceFrameRate=function(S){0>S||125<S?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Zn=0<S?Math.floor(1e3/S):5},O.unstable_getCurrentPriorityLevel=function(){return en},O.unstable_next=function(S){switch(en){case 1:case 2:case 3:var H=3;break;default:H=en}var k=en;en=H;try{return S()}finally{en=k}},O.unstable_requestPaint=function(){B=!0},O.unstable_runWithPriority=function(S,H){switch(S){case 1:case 2:case 3:case 4:case 5:break;default:S=3}var k=en;en=S;try{return H()}finally{en=k}},O.unstable_scheduleCallback=function(S,H,k){var un=O.unstable_now();switch(typeof k=="object"&&k!==null?(k=k.delay,k=typeof k=="number"&&0<k?un+k:un):k=un,S){case 1:var c=-1;break;case 2:c=250;break;case 5:c=1073741823;break;case 4:c=1e4;break;default:c=5e3}return c=k+c,S={id:L++,callback:H,priorityLevel:S,startTime:k,expirationTime:c,sortIndex:-1},k>un?(S.sortIndex=k,P(v,S),U(M)===null&&S===U(v)&&(Vn?(oe(Xn),Xn=-1):Vn=!0,Gn(X,k-un))):(S.sortIndex=c,P(M,S),Dn||Wn||(Dn=!0,qn||(qn=!0,Kn()))),S},O.unstable_shouldYield=Na,O.unstable_wrapCallback=function(S){var H=en;return function(){var k=en;en=H;try{return S.apply(this,arguments)}finally{en=k}}}}(nr)),nr}var nf;function Md(){return nf||(nf=1,$u.exports=Ld()),$u.exports}var er={exports:{}},zn={};/**
 * @license React
...
隠す　お気に入りの一輪
舞い上がる風に託すよ
いつまでも愛に満ちた日々を`}],zd=({song:O,onClose:P})=>{if(!O)return null;const U=Y=>Y==="t"?"披露あり":Y==="f"?"未披露":"不明",g=O.album.filter(Y=>Y.includes("[")&&Y.includes("]"));return W.jsx("div",{className:"modal-overlay",onClick:P,children:W.jsxs("div",{className:"modal-content",onClick:Y=>Y.stopPropagation(),children:[W.jsx("h2",{children:O.title}),W.jsxs("p",{children:[W.jsx("strong",{children:"作詞者:"})," ",W.jsx("span",{className:"modal-item-value",children:O.lyricist})]}),"   ",W.jsxs("p",{children:[W.jsx("strong",{children:"作曲者:"})," ",W.jsx("span",{className:"modal-item-value",children:O.composer})]})," ",O.arranger&&W.jsxs("p",{children:[W.jsx("strong",{children:"編曲者:"})," ",W.jsx("span",{className:"modal-item-value",children:O.arranger})]}),O.brassarrange&&W.jsxs("p",{children:[W.jsx("strong",{children:"ブラスアレンジ:"})," ",W.jsx("span",{className:"modal-item-value",children:O.brassarrange})]}),O.produce&&W.jsxs("p",{children:[W.jsx("strong",{children:"プロデュース:"})," ",W.jsx("span",{className:"modal-item-value",children:O.produce})]}),O.stringsarrange&&W.jsxs("p",{children:[W.jsx("strong",{children:"ストリングスアレンジ:"})," ",W.jsx("span",{className:"modal-item-value",children:O.stringsarrange})]}),O.translate&&W.jsxs("p",{children:[W.jsx("strong",{children:"英訳詞:"})," ",W.jsx("span",{className:"modal-item-value",children:O.translate})]}),W.jsxs("p",{children:[W.jsx("strong",{children:"ユニット:"})," ",W.jsx("span",{className:"modal-item-value",children:O.singer||"WEST."})]})," ",W.jsxs("p",{children:[W.jsx("strong",{children:"発売日:"})," ",W.jsx("span",{className:"modal-item-value",children:O.date})]}),"      ",O.tiup&&W.jsxs("p",{children:[W.jsx("strong",{children:"タイアップ:"})," ",W.jsx("span",{className:"modal-item-value",children:O.tiup})]}),W.jsx("p",{children:W.jsx("strong",{children:"収録シングル/アルバム:"})}),W.jsxs("ul",{children:[g.map((Y,V)=>W.jsx("li",{children:W.jsx("span",{className:"modal-item-value",children:Y})},V)),g.length===0&&W.jsx("li",{children:W.jsx("span",{className:"modal-item-value",children:"[]付きの収録はありません"})})]}),W.jsxs("p",{children:[W.jsx("strong",{children:"披露情報:"})," ",W.jsx("span",{className:"modal-item-value",children:U(O.announce)})]})," ",O.lyrics&&W.jsxs("div",{className:"lyrics-section",children:[" ",W.jsx("h3",{children:"歌詞"}),W.jsx("p",{className:"modal-lyrics-text",children:O.lyrics})," "]}),W.jsx("button",{onClick:P,className:"modal-close-button",children:"閉じる"})]})})},Ud=["タイトル","作詞者","作曲者","収録","披露","ユニット"];function Id(){const[O,P]=Ma.useState(""),[U,g]=Ma.useState("タイトル"),[Y,V]=Ma.useState("name_asc"),[sn,On]=Ma.useState(null),[M,v]=Ma.useState(!1);Ma.useEffect(()=>{P("")},[U]);const L=["ええじゃないか","ええじゃないか[初回盤]","ええじゃないか[MY BEST CD盤]","ええじゃないか[通常盤]","go WEST よーいドン！","go WEST よーいドン！[初回盤]","go WEST よーいドン！[通常盤]","ジパング・おおきに大作戦/夢を抱きしめて","ジパング・おおきに大作戦/夢を抱きしめて[初回A]","ジパング・おおきに大作戦/夢を抱きしめて[初回B]","ジパング・おおきに大作戦/夢を抱きしめて[初回C]","ジパング・おおきに大作戦/夢を抱きしめて[通常盤]","ズンドコ パラダイス","ズンドコ パラダイス[初回A]","ズンドコ パラダイス[初回B]","ズンドコ パラダイス[通常盤]","パリピポ","パリピポ[初回盤]","パリピポ[通常盤]","バリ ハピ","バリ ハピ[初回A]","バリ ハピ[初回B]","バリ ハピ[通常盤]","ラッキィィィィィィィ7","ラッキィィィィィィィ7[初回盤]","ラッキィィィィィィィ7[通常盤]","逆転Winner","逆転Winner[初回A]","逆転Winner[初回B]","逆転Winner[通常盤]","人生は素晴らしい","人生は素晴らしい[初回A]","人生は素晴らしい[初回B]","人生は素晴らしい[通常盤]","なうぇすと","なうぇすと[初回盤]","なうぇすと[通常盤]","おーさか☆愛・EYE・哀/Ya! Hot! Hot!","おーさか☆愛・EYE・哀/Ya! Hot! Hot![初回A]","おーさか☆愛・EYE・哀/Ya! Hot! Hot![初回B]","おーさか☆愛・EYE・哀/Ya! Hot! Hot![通常盤]","僕ら今日も生きている/考えるな、燃えろ!!","僕ら今日も生きている/考えるな、燃えろ!![初回A]","僕ら今日も生きている/考えるな、燃えろ!![初回B]","僕ら今日も生きている/考えるな、燃えろ!![通常盤]","WESTival","WESTival[初回盤]","WESTival[通常盤]","プリンシパルの君へ/ドラゴンドッグ","プリンシパルの君へ/ドラゴンドッグ[初回A]","プリンシパルの君へ/ドラゴンドッグ[初回B]","プリンシパルの君へ/ドラゴンドッグ[通常盤]","スタートダッシュ!","スタートダッシュ![初回A]","スタートダッシュ![初回B]","スタートダッシュ![通常盤]","WESTV！","WESTV！[初回盤]","WESTV！[通常盤]","ホメチギリスト/傷だらけの愛","ホメチギリスト/傷だらけの愛[初回A]","ホメチギリスト/傷だらけの愛[初回B]","ホメチギリスト/傷だらけの愛[通常盤]","アメノチハレ","アメノチハレ[初回A]","アメノチハレ[初回B]","アメノチハレ[通常盤]","Big Shot!!","Big Shot!![初回A]","Big Shot!![初回B]","Big Shot!![通常盤]","W trouble","W trouble[初回A]","W trouble[初回B]","W trouble[通常盤]","W trouble[通販盤]","証拠","証拠[初回A]","証拠[初回B]","証拠[通常盤]","週刊うまくいく曜日","週刊うまくいく曜日[初回A]","週刊うまくいく曜日[初回B]","週刊うまくいく曜日[通常盤]","rainboW","rainboW[初回A]","rainboW[初回B]","rainboW[通常盤]","rainboW[通販盤]","サムシング・ニュー","サムシング・ニュー[初回A]","サムシング・ニュー[初回B]","サムシング・ニュー[通常盤]","でっかい愛/喜努愛楽","でっかい愛/喜努愛楽[初回A]","でっかい愛/喜努愛楽[初回B]","でっかい愛/喜努愛楽[通常盤]","黎明/進むしかねぇ","黎明/進むしかねぇ[初回A]","黎明/進むしかねぇ[初回B]","黎明/進むしかねぇ[通常盤]","Mixed Juice","Mixed Juice[初回A]","Mixed Juice[初回B]","Mixed Juice[通常盤]","星の雨","星の雨[初回A]","星の雨[初回B]","星の雨[通常盤]","星の雨[通販盤]","POWER","POWER[初回A]","POWER[初回B]","POWER[通常盤]","POWER[通販盤]","しあわせの花","しあわせの花[初回A]","しあわせの花[初回B]","しあわせの花[通常盤]","しあわせの花[通販盤]","絶体絶命 / Beautiful / AS ONE","絶体絶命 / Beautiful / AS ONE[初回A]","絶体絶命 / Beautiful / AS ONE[初回B]","絶体絶命 / Beautiful / AS ONE[初回C]","絶体絶命 / Beautiful / AS ONE[通常盤]","AWARD","AWARD[初回A]","AWARD[初回B]","AWARD[通常盤]","ハート / FATE","ハート / FATE[初回A]","ハート / FATE[初回B]","ハート / FATE[通常盤]","ハート / FATE[通販盤]","まぁいっか！","まぁいっか！[初回A]","まぁいっか！[初回B]","まぁいっか！[通常盤]","A.H.O. -Audio Hang Out-","A.H.O. -Audio Hang Out-[初回A]","A.H.O. -Audio Hang Out-[初回B]","A.H.O. -Audio Hang Out-[通常盤]","ウェッサイソウル！ / BIG LOVE SONG","ウェッサイソウル！ / BIG LOVE SONG[初回A]","ウェッサイソウル！ / BIG LOVE SONG[初回B]","ウェッサイソウル！ / BIG LOVE SONG[通常盤]"],on=Array.from(new Set(of.map(B=>B.singer).filter(Boolean))),en=[{label:"⇅ 名前順(あ→わ)",value:"name_asc"},{label:"⇅ 名前順(わ→あ)",value:"name_desc"},{label:"⇅ 古い曲順",value:"date_asc"},{label:"⇅ 新しい曲順",value:"date_desc"}],Wn=of.filter(B=>{const Yn=O.toLowerCase();return U==="タイトル"?B.title.toLowerCase().includes(Yn):U==="作詞者"?B.lyricist.toLowerCase().includes(Yn):U==="作曲者"?B.composer.toLowerCase().includes(Yn):U==="収録"?O===""||B.album.includes(O):U==="披露"?O==="披露あり"?B.announce=="t":O==="未披露"?B.announce==="f":!0:U==="ユニット"?O===""||B.singer===O:!0}).sort((B,Yn)=>{const oe=dn=>{const pn=dn.charAt(0);return pn.match(/^[\u3040-\u30FF]/)?0:pn.match(/^[a-zA-Z]/)?1:2};if(Y==="name_asc"||Y==="name_desc"){const dn=oe(B.titleKana),pn=oe(Yn.titleKana);return dn!==pn?Y==="name_asc"?dn-pn:pn-dn:Y==="name_asc"?B.titleKana.localeCompare(Yn.titleKana,"ja",{sensitivity:"base"}):Yn.titleKana.localeCompare(B.titleKana,"ja",{sensitivity:"base"})}return Y==="date_asc"?new Date(B.date)-new Date(Yn.date):Y==="date_desc"?new Date(Yn.date)-new Date(B.date):0}),Dn=B=>{On(B),v(!0)},Vn=()=>{v(!1),On(null)};return W.jsxs("div",{className:"container",children:[W.jsx("h1",{children:"WEST. 楽曲リスト"}),W.jsxs("div",{className:"controls",children:[W.jsx("select",{value:U,onChange:B=>g(B.target.value),children:Ud.map(B=>W.jsx("option",{value:B,children:B},B))}),U==="収録"?W.jsxs("select",{value:O,onChange:B=>P(B.target.value),children:[W.jsx("option",{value:"",children:"すべての収録"}),L.map(B=>W.jsx("option",{value:B,children:B},B))]}):U==="ユニット"?W.jsxs("select",{value:O,onChange:B=>P(B.target.value),children:[W.jsx("option",{value:"",children:"すべてのユニット"}),on.map(B=>W.jsx("option",{value:B,children:B},B))]}):U==="披露"?W.jsxs("select",{value:O,onChange:B=>P(B.target.value),children:[W.jsx("option",{value:"",children:"すべての曲"}),W.jsx("option",{value:"披露あり",children:"披露あり"}),W.jsx("option",{value:"未披露",children:"未披露"})]}):W.jsx("input",{type:"text",placeholder:`${U}で検索...`,value:O,onChange:B=>P(B.target.value)}),W.jsx("select",{value:Y,onChange:B=>V(B.target.value),children:en.map(B=>W.jsx("option",{value:B.value,children:B.label},B.value))})]}),W.jsxs("div",{style:{marginBottom:"0.5rem",fontSize:"0.9rem"},children:[Wn.length," 件の曲が見つかりました"]}),W.jsx("div",{className:"song-list-wrapper",children:W.jsxs("div",{className:"song-list",children:[W.jsxs("div",{className:"song-header",children:[W.jsx("span",{children:"タイトル"}),W.jsx("span",{children:"作詞者"}),W.jsx("span",{children:"作曲者"}),W.jsx("span",{children:"初収録"}),W.jsx("span",{children:"発売日"})]}),Wn.map(B=>W.jsxs("div",{className:"song-card",onClick:()=>Dn(B),children:[W.jsx("span",{className:"song-title",children:B.title}),W.jsx("span",{children:B.lyricist}),W.jsx("span",{children:B.composer}),W.jsx("span",{children:B.album[0]}),W.jsx("span",{className:"song-date",children:B.date})]},B.id))]})}),M&&sn&&W.jsx(zd,{song:sn,onClose:Vn})]})}Cd.createRoot(document.getElementById("root")).render(W.jsx(Ma.StrictMode,{children:W.jsx(Id,{})}));
