(function(){const X=document.createElement("link").relList;if(X&&X.supports&&X.supports("modulepreload"))return;for(const Y of document.querySelectorAll('link[rel="modulepreload"]'))g(Y);new MutationObserver(Y=>{for(const V of Y)if(V.type==="childList")for(const yn of V.addedNodes)yn.tagName==="LINK"&&yn.rel==="modulepreload"&&g(yn)}).observe(document,{childList:!0,subtree:!0});function C(Y){const V={};return Y.integrity&&(V.integrity=Y.integrity),Y.referrerPolicy&&(V.referrerPolicy=Y.referrerPolicy),Y.crossOrigin==="use-credentials"?V.credentials="include":Y.crossOrigin==="anonymous"?V.credentials="omit":V.credentials="same-origin",V}function g(Y){if(Y.ep)return;Y.ep=!0;const V=C(Y);fetch(Y.href,V)}})();var Qu={exports:{}},Al={};/**
 * @license React
 ...
 */var Zy;function Rd(){if(Zy)return Al;Zy=1;var O=Symbol.for("react.transitional.element"),X=Symbol.for("react.fragment");function C(g,Y,V){var yn=null;if(V!==void 0&&(yn=""+V),Y.key!==void 0&&(yn=""+Y.key),"key"in Y){V={};for(var Wn in Y)Wn!=="key"&&(V[Wn]=Y[Wn])}else V=Y;return Y=V.ref,{$$typeof:O,type:g,key:yn,ref:Y!==void 0?Y:null,props:V}}return Al.Fragment=X,Al.jsx=C,Al.jsxs=C,Al}var Qy;function Dd(){return Qy||(Qy=1,Qu.exports=Rd()),Qu.exports}var W=Dd(),Fu={exports:{}},I={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Fy;function Yd(){if(Fy)return I;Fy=1;var O=Symbol.for("react.transitional.element"),X=Symbol.for("react.portal"),C=Symbol.for("react.fragment"),g=Symbol.for("react.strict_mode"),Y=Symbol.for("react.profiler"),V=Symbol.for("react.consumer"),yn=Symbol.for("react.context"),Wn=Symbol.for("react.forward_ref"),M=Symbol.for("react.suspense"),v=Symbol.for("react.memo"),L=Symbol.for("react.lazy"),on=Symbol.iterator;function en(c){return c===null||typeof c!="object"?null:(c=on&&c[on]||c["@@iterator"],typeof c=="function"?c:null)}var pn={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},Yn=Object.assign,qn={};function p(c,T,w){this.props=c,this.context=T,this.refs=qn,this.updater=w||pn}p.prototype.isReactComponent={},p.prototype.setState=function(c,T){if(typeof c!="object"&&typeof c!="function"&&c!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,c,T,"setState")},p.prototype.forceUpdate=function(c){this.updater.enqueueForceUpdate(this,c,"forceUpdate")};function vn(){}vn.prototype=p.prototype;function Un(c,T,w){this.props=c,this.context=T,this.refs=qn,this.updater=w||pn}var sn=Un.prototype=new vn;sn.constructor=Un,Yn(sn,p.prototype),sn.isPureReactComponent=!0;var Hn=Array.isArray,Z={H:null,A:null,T:null,S:null,V:null},Xn=Object.prototype.hasOwnProperty;function Zn(c,T,w,H,N,Q){return w=Q.ref,{$$typeof:O,type:c,key:T,ref:w!==void 0?w:null,props:Q}}function Qn(c,T){return Zn(c.type,T,void 0,void 0,void 0,c.props)}function Ee(c){return typeof c=="object"&&c!==null&&c.$$typeof===O}function Na(c){var T={"=":"=0",":":"=2"};return"$"+c.replace(/[=:]/g,function(w){return T[w]})}var He=/\/+/g;function Kn(c,T){return typeof c=="object"&&c!==null&&c.key!=null?Na(""+c.key):T.toString(36)}function ha(){}function da(c){switch(c.status){case"fulfilled":return c.value;case"rejected":throw c.reason;default:switch(typeof c.status=="string"?c.then(ha,ha):(c.status="pending",c.then(function(T){c.status==="pending"&&(c.status="fulfilled",c.value=T)},function(T){c.status==="pending"&&(c.status="rejected",c.reason=T)})),c.status){case"fulfilled":return c.value;case"rejected":throw c.reason}}throw c}function Gn(c,T,w,H,N){var Q=typeof c;(Q==="undefined"||Q==="boolean")&&(c=null);var U=!1;if(c===null)U=!0;else switch(Q){case"bigint":case"string":case"number":U=!0;break;case"object":switch(c.$$typeof){case O:case X:U=!0;break;case L:return U=c._init,Gn(U(c._payload),T,w,H,N)}}if(U)return N=N(c),U=H===""?"."+Kn(c,0):H,Hn(N)?(w="",U!=null&&(w=U.replace(He,"$&/")+"/"),Gn(N,T,w,"",function(Je){return Je})):N!=null&&(Ee(N)&&(N=Qn(N,w+(N.key==null||c&&c.key===N.key?"":(""+N.key).replace(He,"$&/")+"/")+U)),T.push(N)),1;U=0;var Fn=H===""?".":H+":";if(Hn(c))for(var fn=0;fn<c.length;fn++)H=c[fn],Q=Fn+Kn(H,fn),U+=Gn(H,T,w,Q,N);else if(fn=en(c),typeof fn=="function")for(c=fn.call(c),fn=0;!(H=c.next()).done;)H=H.value,Q=Fn+Kn(H,fn++),U+=Gn(H,T,w,Q,N);else if(Q==="object"){if(typeof c.then=="function")return Gn(da(c),T,w,H,N);throw T=String(c),Error("Objects are not valid as a React child (found: "+(T==="[object Object]"?"object with keys {"+Object.keys(c).join(", ")+"}":T)+"). If you meant to render a collection of children, use an array instead.")}return U}function S(c,T,w){if(c==null)return c;var H=[],N=0;return Gn(c,H,"","",function(Q){return T.call(w,Q,N++)}),H}function B(c){if(c._status===-1){var T=c._result;T=T(),T.then(function(w){(c._status===0||c._status===-1)&&(c._status=1,c._result=w)},function(w){(c._status===0||c._status===-1)&&(c._status=2,c._result=w)}),c._status===-1&&(c._status=0,c._result=T)}if(c._status===1)return c._result.default;throw c._result}var k=typeof reportError=="function"?reportError:function(c){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var T=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof c=="object"&&c!==null&&typeof c.message=="string"?String(c.message):String(c),error:c});if(!window.dispatchEvent(T))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",c);return}console.error(c)};function un(){}return I.Children={map:S,forEach:function(c,T,w){S(c,function(){T.apply(this,arguments)},w)},count:function(c){var T=0;return S(c,function(){T++}),T},toArray:function(c){return S(c,function(T){return T})||[]},only:function(c){if(!Ee(c))throw Error("React.Children.only expected to receive a single React element child.");return c}},I.Component=p,I.Fragment=C,I.Profiler=Y,I.PureComponent=Un,I.StrictMode=g,I.Suspense=M,I.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=Z,I.__COMPILER_RUNTIME={__proto__:null,c:function(c){return Z.H.useMemoCache(c)}},I.cache=function(c){return function(){return c.apply(null,arguments)}},I.cloneElement=function(c,T,w){if(c==null)throw Error("The argument must be a React element, but you passed "+c+".");var H=Yn({},c.props),N=c.key,Q=void 0;if(T!=null)for(U in T.ref!==void 0&&(Q=void 0),T.key!==void 0&&(N=""+T.key),T)!Xn.call(T,U)||U==="key"||U==="__self"||U==="__source"||U==="ref"&&T.ref===void 0||(H[U]=T[U]);var U=arguments.length-2;if(U===1)H.children=w;else if(1<U){for(var Fn=Array(U),fn=0;fn<U;fn++)Fn[fn]=arguments[fn+2];H.children=Fn}return Zn(c.type,N,void 0,void 0,Q,H)},I.createContext=function(c){return c={$$typeof:yn,_currentValue:c,_currentValue2:c,_threadCount:0,Provider:null,Consumer:null},c.Provider=c,c.Consumer={$$typeof:V,_context:c},c},I.createElement=function(c,T,w){var H,N={},Q=null;if(T!=null)for(H in T.key!==void 0&&(Q=""+T.key),T)Xn.call(T,H)&&H!=="key"&&H!=="__self"&&H!=="__source"&&(N[H]=T[H]);var U=arguments.length-2;if(U===1)N.children=w;else if(1<U){for(var Fn=Array(U),fn=0;fn<U;fn++)Fn[fn]=arguments[fn+2];N.children=Fn}if(c&&c.defaultProps)for(H in U=c.defaultProps,U)N[H]===void 0&&(N[H]=U[H]);return Zn(c,Q,void 0,void 0,null,N)},I.createRef=function(){return{current:null}},I.forwardRef=function(c){return{$$typeof:Wn,render:c}},I.isValidElement=Ee,I.lazy=function(c){return{$$typeof:L,_payload:{_status:-1,_result:c},_init:B}},I.memo=function(c,T){return{$$typeof:v,type:c,compare:T===void 0?null:T}},I.startTransition=function(c){var T=Z.T,w={};Z.T=w;try{var H=c(),N=Z.S;N!==null&&N(w,H),typeof H=="object"&&H!==null&&typeof H.then=="function"&&H.then(un,k)}catch(Q){k(Q)}finally{Z.T=T}},I.unstable_useCacheRefresh=function(){return Z.H.useCacheRefresh()},I.use=function(c){return Z.H.use(c)},I.useActionState=function(c,T,w){return Z.H.useActionState(c,T,w)},I.useCallback=function(c,T){return Z.H.useCallback(c,T)},I.useContext=function(c){return Z.H.useContext(c)},I.useDebugValue=function(){},I.useDeferredValue=function(c,T){return Z.H.useDeferredValue(c,T)},I.useEffect=function(c,T,w){var H=Z.H;if(typeof w=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return H.useEffect(c,T)},I.useId=function(){return Z.H.useId()},I.useImperativeHandle=function(c,T,w){return Z.H.useImperativeHandle(c,T,w)},I.useInsertionEffect=function(c,T){return Z.H.useInsertionEffect(c,T)},I.useLayoutEffect=function(c,T){return Z.H.useLayoutEffect(c,T)},I.useMemo=function(c,T){return Z.H.useMemo(c,T)},I.useOptimistic=function(c,T){return Z.H.useOptimistic(c,T)},I.useReducer=function(c,T,w){return Z.H.useReducer(c,T,w)},I.useRef=function(c){return Z.H.useRef(c)},I.useState=function(c){return Z.H.useState(c)},I.useSyncExternalStore=function(c,T,w){return Z.H.useSyncExternalStore(c,T,w)},I.useTransition=function(){return Z.H.useTransition()},I.version="19.1.0",I}var Py;function ar(){return Py||(Py=1,Fu.exports=Yd()),Fu.exports}var Ma=ar(),Pu={exports:{}},Sl={},$u={exports:{}},nr={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var $y;function Ld(){return $y||($y=1,function(O){function X(S,B){var k=S.length;S.push(B);n:for(;0<k;){var un=k-1>>>1,c=S[un];if(0<Y(c,B))S[un]=B,S[k]=c,k=un;else break n}}function C(S){return S.length===0?null:S[0]}function g(S){if(S.length===0)return null;var B=S[0],k=S.pop();if(k!==B){S[0]=k;n:for(var un=0,c=S.length,T=c>>>1;un<T;){var w=2*(un+1)-1,H=S[w],N=w+1,Q=S[N];if(0>Y(H,k))N<c&&0>Y(Q,H)?(S[un]=Q,S[N]=k,un=N):(S[un]=H,S[w]=k,un=w);else if(N<c&&0>Y(Q,k))S[un]=Q,S[N]=k,un=N;else break n}}return B}function Y(S,B){var k=S.sortIndex-B.sortIndex;return k!==0?k:S.id-B.id}if(O.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var V=performance;O.unstable_now=function(){return V.now()}}else{var yn=Date,Wn=yn.now();O.unstable_now=function(){return yn.now()-Wn}}var M=[],v=[],L=1,on=null,en=3,pn=!1,Yn=!1,qn=!1,p=!1,vn=typeof setTimeout=="function"?setTimeout:null,Un=typeof clearTimeout=="function"?clearTimeout:null,sn=typeof setImmediate<"u"?setImmediate:null;function Hn(S){for(var B=C(v);B!==null;){if(B.callback===null)g(v);else if(B.startTime<=S)g(v),B.sortIndex=B.expirationTime,X(M,B);else break;B=C(v)}}function Z(S){if(qn=!1,Hn(S),!Yn)if(C(M)!==null)Yn=!0,Xn||(Xn=!0,Kn());else{var B=C(v);B!==null&&Gn(Z,B.startTime-S)}}var Xn=!1,Zn=-1,Qn=5,Ee=-1;function Na(){return p?!0:!(O.unstable_now()-Ee<Qn)}function He(){if(p=!1,Xn){var S=O.unstable_now();Ee=S;var B=!0;try{n:{Yn=!1,qn&&(qn=!1,Un(Zn),Zn=-1),pn=!0;var k=en;try{e:{for(Hn(S),on=C(M);on!==null&&!(on.expirationTime>S&&Na());){var un=on.callback;if(typeof un=="function"){on.callback=null,en=on.priorityLevel;var c=un(on.expirationTime<=S);if(S=O.unstable_now(),typeof c=="function"){on.callback=c,Hn(S),B=!0;break e}on===C(M)&&g(M),Hn(S)}else g(M);on=C(M)}if(on!==null)B=!0;else{var T=C(v);T!==null&&Gn(Z,T.startTime-S),B=!1}}break n}finally{on=null,en=k,pn=!1}B=void 0}}finally{B?Kn():Xn=!1}}}var Kn;if(typeof sn=="function")Kn=function(){sn(He)};else if(typeof MessageChannel<"u"){var ha=new MessageChannel,da=ha.port2;ha.port1.onmessage=He,Kn=function(){da.postMessage(null)}}else Kn=function(){vn(He,0)};function Gn(S,B){Zn=vn(function(){S(O.unstable_now())},B)}O.unstable_IdlePriority=5,O.unstable_ImmediatePriority=1,O.unstable_LowPriority=4,O.unstable_NormalPriority=3,O.unstable_Profiling=null,O.unstable_UserBlockingPriority=2,O.unstable_cancelCallback=function(S){S.callback=null},O.unstable_forceFrameRate=function(S){0>S||125<S?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Qn=0<S?Math.floor(1e3/S):5},O.unstable_getCurrentPriorityLevel=function(){return en},O.unstable_next=function(S){switch(en){case 1:case 2:case 3:var B=3;break;default:B=en}var k=en;en=B;try{return S()}finally{en=k}},O.unstable_requestPaint=function(){p=!0},O.unstable_runWithPriority=function(S,B){switch(S){case 1:case 2:case 3:case 4:case 5:break;default:S=3}var k=en;en=S;try{return B()}finally{en=k}},O.unstable_scheduleCallback=function(S,B,k){var un=O.unstable_now();switch(typeof k=="object"&&k!==null?(k=k.delay,k=typeof k=="number"&&0<k?un+k:un):k=un,S){case 1:var c=-1;break;case 2:c=250;break;case 5:c=1073741823;break;case 4:c=1e4;break;default:c=5e3}return c=k+c,S={id:L++,callback:B,priorityLevel:S,startTime:k,expirationTime:c,sortIndex:-1},k>un?(S.sortIndex=k,X(v,S),C(M)===null&&S===C(v)&&(qn?(Un(Zn),Zn=-1):qn=!0,Gn(Z,k-un))):(S.sortIndex=c,X(M,S),Yn||pn||(Yn=!0,Xn||(Xn=!0,Kn()))),S},O.unstable_shouldYield=Na,O.unstable_wrapCallback=function(S){var B=en;return function(){var k=en;en=B;try{return S.apply(this,arguments)}finally{en=k}}}}(nr)),nr}var nf;function Md(){return nf||(nf=1,$u.exports=Ld()),$u.exports}var er={exports:{}},zn={};/**
 * @license React
...
隠す　お気に入りの一輪
舞い上がる風に託すよ
いつまでも愛に満ちた日々を`}],zd=({song:O,onClose:X})=>{if(!O)return null;const C=Y=>Y==="t"?"披露あり":Y==="f"?"未披露":"不明",g=O.album.filter(Y=>Y.includes("[")&&Y.includes("]"));return W.jsx("div",{className:"modal-overlay",onClick:X,children:W.jsxs("div",{className:"modal-content",onClick:Y=>Y.stopPropagation(),children:[W.jsx("h2",{children:O.title}),W.jsxs("p",{children:[W.jsx("strong",{children:"作詞者:"})," ",W.jsx("span",{className:"modal-item-value",children:O.lyricist})]}),"   ",W.jsxs("p",{children:[W.jsx("strong",{children:"作曲者:"})," ",W.jsx("span",{className:"modal-item-value",children:O.composer})]})," ",O.arranger&&W.jsxs("p",{children:[W.jsx("strong",{children:"編曲者:"})," ",W.jsx("span",{className:"modal-item-value",children:O.arranger})]}),O.brassarrange&&W.jsxs("p",{children:[W.jsx("strong",{children:"ブラスアレンジ:"})," ",W.jsx("span",{className:"modal-item-value",children:O.brassarrange})]}),O.produce&&W.jsxs("p",{children:[W.jsx("strong",{children:"プロデュース:"})," ",W.jsx("span",{className:"modal-item-value",children:O.produce})]}),O.stringsarrange&&W.jsxs("p",{children:[W.jsx("strong",{children:"ストリングスアレンジ:"})," ",W.jsx("span",{className:"modal-item-value",children:O.stringsarrange})]}),O.translate&&W.jsxs("p",{children:[W.jsx("strong",{children:"英訳詞:"})," ",W.jsx("span",{className:"modal-item-value",children:O.translate})]}),W.jsxs("p",{children:[W.jsx("strong",{children:"ユニット:"})," ",W.jsx("span",{className:"modal-item-value",children:O.singer||"WEST."})]})," ",W.jsxs("p",{children:[W.jsx("strong",{children:"発売日:"})," ",W.jsx("span",{className:"modal-item-value",children:O.date})]}),"      ",O.tiup&&W.jsxs("p",{children:[W.jsx("strong",{children:"タイアップ:"})," ",W.jsx("span",{className:"modal-item-value",children:O.tiup})]}),W.jsx("p",{children:W.jsx("strong",{children:"収録シングル/アルバム:"})}),W.jsxs("ul",{children:[g.map((Y,V)=>W.jsx("li",{children:W.jsx("span",{className:"modal-item-value",children:Y})},V)),g.length===0&&W.jsx("li",{children:W.jsx("span",{className:"modal-item-value",children:"[]付きの収録はありません"})})]}),W.jsxs("p",{children:[W.jsx("strong",{children:"披露情報:"})," ",W.jsx("span",{className:"modal-item-value",children:C(O.announce)})]})," ",O.lyrics&&W.jsxs("div",{className:"lyrics-section",children:[" ",W.jsx("h3",{children:"歌詞"}),W.jsx("p",{className:"modal-lyrics-text",children:O.lyrics})," "]}),W.jsx("button",{onClick:X,className:"modal-close-button",children:"閉じる"})]})})},Ud=["タイトル","作詞者","作曲者","編曲者","歌詞","収録","披露","ユニット","タイアップ"];function Id(){const[O,X]=Ma.useState(""),[C,g]=Ma.useState("タイトル"),[Y,V]=Ma.useState("name_asc"),[yn,Wn]=Ma.useState(null),[M,v]=Ma.useState(!1);Ma.useEffect(()=>{X("")},[C]);const L=["ええじゃないか","ええじゃないか[初回盤]","ええじゃないか[MY BEST CD盤]","ええじゃないか[通常盤]","go WEST よーいドン！","go WEST よーいドン！[初回盤]","go WEST よーいドン！[通常盤]","ジパング・おおきに大作戦/夢を抱きしめて","ジパング・おおきに大作戦/夢を抱きしめて[初回A]","ジパング・おおきに大作戦/夢を抱きしめて[初回B]","ジパング・おおきに大作戦/夢を抱きしめて[初回C]","ジパング・おおきに大作戦/夢を抱きしめて[通常盤]","ズンドコ パラダイス","ズンドコ パラダイス[初回A]","ズンドコ パラダイス[初回B]","ズンドコ パラダイス[通常盤]","パリピポ","パリピポ[初回盤]","パリピポ[通常盤]","バリ ハピ","バリ ハピ[初回A]","バリ ハピ[初回B]","バリ ハピ[通常盤]","ラッキィィィィィィィ7","ラッキィィィィィィィ7[初回盤]","ラッキィィィィィィィ7[通常盤]","逆転Winner","逆転Winner[初回A]","逆転Winner[初回B]","逆転Winner[通常盤]","人生は素晴らしい","人生は素晴らしい[初回A]","人生は素晴らしい[初回B]","人生は素晴らしい[通常盤]","なうぇすと","なうぇすと[初回盤]","なうぇすと[通常盤]","おーさか☆愛・EYE・哀/Ya! Hot! Hot!","おーさか☆愛・EYE・哀/Ya! Hot! Hot![初回A]","おーさか☆愛・EYE・哀/Ya! Hot! Hot![初回B]","おーさか☆愛・EYE・哀/Ya! Hot! Hot![通常盤]","僕ら今日も生きている/考えるな、燃えろ!!","僕ら今日も生きている/考えるな、燃えろ!![初回A]","僕ら今日も生きている/考えるな、燃えろ!![初回B]","僕ら今日も生きている/考えるな、燃えろ!![通常盤]","WESTival","WESTival[初回盤]","WESTival[通常盤]","プリンシパルの君へ/ドラゴンドッグ","プリンシパルの君へ/ドラゴンドッグ[初回A]","プリンシパルの君へ/ドラゴンドッグ[初回B]","プリンシパルの君へ/ドラゴンドッグ[通常盤]","スタートダッシュ!","スタートダッシュ![初回A]","スタートダッシュ![初回B]","スタートダッシュ![通常盤]","WESTV！","WESTV！[初回盤]","WESTV！[通常盤]","ホメチギリスト/傷だらけの愛","ホメチギリスト/傷だらけの愛[初回A]","ホメチギリスト/傷だらけの愛[初回B]","ホメチギリスト/傷だらけの愛[通常盤]","アメノチハレ","アメノチハレ[初回A]","アメノチハレ[初回B]","アメノチハレ[通常盤]","Big Shot!!","Big Shot!![初回A]","Big Shot!![初回B]","Big Shot!![通常盤]","W trouble","W trouble[初回A]","W trouble[初回B]","W trouble[通常盤]","W trouble[通販盤]","証拠","証拠[初回A]","証拠[初回B]","証拠[通常盤]","週刊うまくいく曜日","週刊うまくいく曜日[初回A]","週刊うまくいく曜日[初回B]","週刊うまくいく曜日[通常盤]","rainboW","rainboW[初回A]","rainboW[初回B]","rainboW[通常盤]","rainboW[通販盤]","サムシング・ニュー","サムシング・ニュー[初回A]","サムシング・ニュー[初回B]","サムシング・ニュー[通常盤]","でっかい愛/喜努愛楽","でっかい愛/喜努愛楽[初回A]","でっかい愛/喜努愛楽[初回B]","でっかい愛/喜努愛楽[通常盤]","黎明/進むしかねぇ","黎明/進むしかねぇ[初回A]","黎明/進むしかねぇ[初回B]","黎明/進むしかねぇ[通常盤]","Mixed Juice","Mixed Juice[初回A]","Mixed Juice[初回B]","Mixed Juice[通常盤]","星の雨","星の雨[初回A]","星の雨[初回B]","星の雨[通常盤]","星の雨[通販盤]","POWER","POWER[初回A]","POWER[初回B]","POWER[通常盤]","POWER[通販盤]","しあわせの花","しあわせの花[初回A]","しあわせの花[初回B]","しあわせの花[通常盤]","しあわせの花[通販盤]","絶体絶命 / Beautiful / AS ONE","絶体絶命 / Beautiful / AS ONE[初回A]","絶体絶命 / Beautiful / AS ONE[初回B]","絶体絶命 / Beautiful / AS ONE[初回C]","絶体絶命 / Beautiful / AS ONE[通常盤]","AWARD","AWARD[初回A]","AWARD[初回B]","AWARD[通常盤]","ハート / FATE","ハート / FATE[初回A]","ハート / FATE[初回B]","ハート / FATE[通常盤]","ハート / FATE[通販盤]","まぁいっか！","まぁいっか！[初回A]","まぁいっか！[初回B]","まぁいっか！[通常盤]","A.H.O. -Audio Hang Out-","A.H.O. -Audio Hang Out-[初回A]","A.H.O. -Audio Hang Out-[初回B]","A.H.O. -Audio Hang Out-[通常盤]","ウェッサイソウル！ / BIG LOVE SONG","ウェッサイソウル！ / BIG LOVE SONG[初回A]","ウェッサイソウル！ / BIG LOVE SONG[初回B]","ウェッサイソウル！ / BIG LOVE SONG[通常盤]"],on=Array.from(new Set(of.map(p=>p.singer).filter(Boolean))),en=[{label:"⇅ 名前順(あ→わ)",value:"name_asc"},{label:"⇅ 名前順(わ→あ)",value:"name_desc"},{label:"⇅ 古い曲順",value:"date_asc"},{label:"⇅ 新しい曲順",value:"date_desc"}],pn=of.filter(p=>{const vn=O.toLowerCase(),Un=sn=>sn?sn.toLowerCase().replace(/[！♪？「」（）、。、～…]/g,"").replace(/[\s　]+/g," ").trim():"";return C==="タイトル"?p.title.toLowerCase().includes(vn):C==="作詞者"?p.lyricist.toLowerCase().includes(vn):C==="作曲者"?p.composer.toLowerCase().includes(vn):C==="編曲者"?p.arranger.toLowerCase().includes(vn):C==="歌詞"?Un(p.lyrics).includes(Un(vn)):C==="収録"?O===""||p.album.includes(O):C==="披露"?O==="披露あり"?p.announce=="t":O==="未披露"?p.announce==="f":!0:C==="ユニット"?O===""||p.singer===O:C==="タイアップ"?O==="あり"?p.tiup&&p.tiup.trim()!=="":O==="なし"?!p.tiup||p.tiup.trim()==="":!0:!0}).sort((p,vn)=>{const Un=sn=>{const Hn=sn.charAt(0);return Hn.match(/^[\u3040-\u30FF]/)?0:Hn.match(/^[a-zA-Z]/)?1:2};if(Y==="name_asc"||Y==="name_desc"){const sn=Un(p.titleKana),Hn=Un(vn.titleKana);return sn!==Hn?Y==="name_asc"?sn-Hn:Hn-sn:Y==="name_asc"?p.titleKana.localeCompare(vn.titleKana,"ja",{sensitivity:"base"}):vn.titleKana.localeCompare(p.titleKana,"ja",{sensitivity:"base"})}return Y==="date_asc"?new Date(p.date)-new Date(vn.date):Y==="date_desc"?new Date(vn.date)-new Date(p.date):0}),Yn=p=>{Wn(p),v(!0)},qn=()=>{v(!1),Wn(null)};return W.jsxs("div",{className:"container",children:[W.jsx("h1",{children:"WEST. 楽曲リスト"}),W.jsxs("div",{className:"controls",children:[W.jsx("select",{value:C,onChange:p=>g(p.target.value),children:Ud.map(p=>W.jsx("option",{value:p,children:p},p))}),C==="収録"?W.jsxs("select",{value:O,onChange:p=>X(p.target.value),children:[W.jsx("option",{value:"",children:"すべての収録"}),L.map(p=>W.jsx("option",{value:p,children:p},p))]}):C==="ユニット"?W.jsxs("select",{value:O,onChange:p=>X(p.target.value),children:[W.jsx("option",{value:"",children:"すべてのユニット"}),on.map(p=>W.jsx("option",{value:p,children:p},p))]}):C==="披露"?W.jsxs("select",{value:O,onChange:p=>X(p.target.value),children:[W.jsx("option",{value:"",children:"すべての曲"}),W.jsx("option",{value:"披露あり",children:"披露あり"}),W.jsx("option",{value:"未披露",children:"未披露"})]}):C==="タイアップ"?W.jsxs("select",{value:O,onChange:p=>X(p.target.value),children:[W.jsx("option",{value:"",children:"すべて"})," ",W.jsx("option",{value:"あり",children:"あり"}),W.jsx("option",{value:"なし",children:"なし"})]}):C==="歌詞"?W.jsx("input",{type:"text",placeholder:"歌詞で検索...",value:O,onChange:p=>X(p.target.value)}):W.jsx("input",{type:"text",placeholder:`${C}で検索...`,value:O,onChange:p=>X(p.target.value)}),W.jsx("select",{value:Y,onChange:p=>V(p.target.value),children:en.map(p=>W.jsx("option",{value:p.value,children:p.label},p.value))})]}),W.jsxs("div",{style:{marginBottom:"0.5rem",fontSize:"0.9rem"},children:[pn.length," 件の曲が見つかりました"]}),W.jsx("div",{className:"song-list-wrapper",children:W.jsxs("div",{className:"song-list",children:[W.jsxs("div",{className:"song-header",children:[W.jsx("span",{children:"タイトル"}),W.jsx("span",{children:"作詞者"}),W.jsx("span",{children:"作曲者"}),W.jsx("span",{children:"初収録"}),W.jsx("span",{children:"発売日"})]}),pn.map(p=>W.jsxs("div",{className:"song-card",onClick:()=>Yn(p),children:[W.jsx("span",{className:"song-title",children:p.title}),W.jsx("span",{children:p.lyricist}),W.jsx("span",{children:p.composer}),W.jsx("span",{children:p.album[0]}),W.jsx("span",{className:"song-date",children:p.date})]},p.id))]})}),M&&yn&&W.jsx(zd,{song:yn,onClose:qn})]})}Cd.createRoot(document.getElementById("root")).render(W.jsx(Ma.StrictMode,{children:W.jsx(Id,{})}));
