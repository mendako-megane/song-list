(function(){const F=document.createElement("link").relList;if(F&&F.supports&&F.supports("modulepreload"))return;for(const Y of document.querySelectorAll('link[rel="modulepreload"]'))g(Y);new MutationObserver(Y=>{for(const V of Y)if(V.type==="childList")for(const sn of V.addedNodes)sn.tagName==="LINK"&&sn.rel==="modulepreload"&&g(sn)}).observe(document,{childList:!0,subtree:!0});function z(Y){const V={};return Y.integrity&&(V.integrity=Y.integrity),Y.referrerPolicy&&(V.referrerPolicy=Y.referrerPolicy),Y.crossOrigin==="use-credentials"?V.credentials="include":Y.crossOrigin==="anonymous"?V.credentials="omit":V.credentials="same-origin",V}function g(Y){if(Y.ep)return;Y.ep=!0;const V=z(Y);fetch(Y.href,V)}})();var Qu={exports:{}},Al={};/**
 * @license React
 ...
 */var Zy;function Rd(){if(Zy)return Al;Zy=1;var O=Symbol.for("react.transitional.element"),F=Symbol.for("react.fragment");function z(g,Y,V){var sn=null;if(V!==void 0&&(sn=""+V),Y.key!==void 0&&(sn=""+Y.key),"key"in Y){V={};for(var Wn in Y)Wn!=="key"&&(V[Wn]=Y[Wn])}else V=Y;return Y=V.ref,{$$typeof:O,type:g,key:sn,ref:Y!==void 0?Y:null,props:V}}return Al.Fragment=F,Al.jsx=z,Al.jsxs=z,Al}var Qy;function Dd(){return Qy||(Qy=1,Qu.exports=Rd()),Qu.exports}var W=Dd(),Fu={exports:{}},I={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Fy;function Yd(){if(Fy)return I;Fy=1;var O=Symbol.for("react.transitional.element"),F=Symbol.for("react.portal"),z=Symbol.for("react.fragment"),g=Symbol.for("react.strict_mode"),Y=Symbol.for("react.profiler"),V=Symbol.for("react.consumer"),sn=Symbol.for("react.context"),Wn=Symbol.for("react.forward_ref"),M=Symbol.for("react.suspense"),v=Symbol.for("react.memo"),L=Symbol.for("react.lazy"),on=Symbol.iterator;function en(c){return c===null||typeof c!="object"?null:(c=on&&c[on]||c["@@iterator"],typeof c=="function"?c:null)}var pn={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},Yn=Object.assign,Vn={};function p(c,T,w){this.props=c,this.context=T,this.refs=Vn,this.updater=w||pn}p.prototype.isReactComponent={},p.prototype.setState=function(c,T){if(typeof c!="object"&&typeof c!="function"&&c!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,c,T,"setState")},p.prototype.forceUpdate=function(c){this.updater.enqueueForceUpdate(this,c,"forceUpdate")};function vn(){}vn.prototype=p.prototype;function oe(c,T,w){this.props=c,this.context=T,this.refs=Vn,this.updater=w||pn}var dn=oe.prototype=new vn;dn.constructor=oe,Yn(dn,p.prototype),dn.isPureReactComponent=!0;var Hn=Array.isArray,X={H:null,A:null,T:null,S:null,V:null},qn=Object.prototype.hasOwnProperty;function Xn(c,T,w,H,N,Z){return w=Z.ref,{$$typeof:O,type:c,key:T,ref:w!==void 0?w:null,props:Z}}function Zn(c,T){return Xn(c.type,T,void 0,void 0,void 0,c.props)}function Ee(c){return typeof c=="object"&&c!==null&&c.$$typeof===O}function Na(c){var T={"=":"=0",":":"=2"};return"$"+c.replace(/[=:]/g,function(w){return T[w]})}var He=/\/+/g;function Kn(c,T){return typeof c=="object"&&c!==null&&c.key!=null?Na(""+c.key):T.toString(36)}function ha(){}function da(c){switch(c.status){case"fulfilled":return c.value;case"rejected":throw c.reason;default:switch(typeof c.status=="string"?c.then(ha,ha):(c.status="pending",c.then(function(T){c.status==="pending"&&(c.status="fulfilled",c.value=T)},function(T){c.status==="pending"&&(c.status="rejected",c.reason=T)})),c.status){case"fulfilled":return c.value;case"rejected":throw c.reason}}throw c}function Gn(c,T,w,H,N){var Z=typeof c;(Z==="undefined"||Z==="boolean")&&(c=null);var U=!1;if(c===null)U=!0;else switch(Z){case"bigint":case"string":case"number":U=!0;break;case"object":switch(c.$$typeof){case O:case F:U=!0;break;case L:return U=c._init,Gn(U(c._payload),T,w,H,N)}}if(U)return N=N(c),U=H===""?"."+Kn(c,0):H,Hn(N)?(w="",U!=null&&(w=U.replace(He,"$&/")+"/"),Gn(N,T,w,"",function(Je){return Je})):N!=null&&(Ee(N)&&(N=Zn(N,w+(N.key==null||c&&c.key===N.key?"":(""+N.key).replace(He,"$&/")+"/")+U)),T.push(N)),1;U=0;var Qn=H===""?".":H+":";if(Hn(c))for(var yn=0;yn<c.length;yn++)H=c[yn],Z=Qn+Kn(H,yn),U+=Gn(H,T,w,Z,N);else if(yn=en(c),typeof yn=="function")for(c=yn.call(c),yn=0;!(H=c.next()).done;)H=H.value,Z=Qn+Kn(H,yn++),U+=Gn(H,T,w,Z,N);else if(Z==="object"){if(typeof c.then=="function")return Gn(da(c),T,w,H,N);throw T=String(c),Error("Objects are not valid as a React child (found: "+(T==="[object Object]"?"object with keys {"+Object.keys(c).join(", ")+"}":T)+"). If you meant to render a collection of children, use an array instead.")}return U}function S(c,T,w){if(c==null)return c;var H=[],N=0;return Gn(c,H,"","",function(Z){return T.call(w,Z,N++)}),H}function B(c){if(c._status===-1){var T=c._result;T=T(),T.then(function(w){(c._status===0||c._status===-1)&&(c._status=1,c._result=w)},function(w){(c._status===0||c._status===-1)&&(c._status=2,c._result=w)}),c._status===-1&&(c._status=0,c._result=T)}if(c._status===1)return c._result.default;throw c._result}var k=typeof reportError=="function"?reportError:function(c){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var T=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof c=="object"&&c!==null&&typeof c.message=="string"?String(c.message):String(c),error:c});if(!window.dispatchEvent(T))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",c);return}console.error(c)};function un(){}return I.Children={map:S,forEach:function(c,T,w){S(c,function(){T.apply(this,arguments)},w)},count:function(c){var T=0;return S(c,function(){T++}),T},toArray:function(c){return S(c,function(T){return T})||[]},only:function(c){if(!Ee(c))throw Error("React.Children.only expected to receive a single React element child.");return c}},I.Component=p,I.Fragment=z,I.Profiler=Y,I.PureComponent=oe,I.StrictMode=g,I.Suspense=M,I.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=X,I.__COMPILER_RUNTIME={__proto__:null,c:function(c){return X.H.useMemoCache(c)}},I.cache=function(c){return function(){return c.apply(null,arguments)}},I.cloneElement=function(c,T,w){if(c==null)throw Error("The argument must be a React element, but you passed "+c+".");var H=Yn({},c.props),N=c.key,Z=void 0;if(T!=null)for(U in T.ref!==void 0&&(Z=void 0),T.key!==void 0&&(N=""+T.key),T)!qn.call(T,U)||U==="key"||U==="__self"||U==="__source"||U==="ref"&&T.ref===void 0||(H[U]=T[U]);var U=arguments.length-2;if(U===1)H.children=w;else if(1<U){for(var Qn=Array(U),yn=0;yn<U;yn++)Qn[yn]=arguments[yn+2];H.children=Qn}return Xn(c.type,N,void 0,void 0,Z,H)},I.createContext=function(c){return c={$$typeof:sn,_currentValue:c,_currentValue2:c,_threadCount:0,Provider:null,Consumer:null},c.Provider=c,c.Consumer={$$typeof:V,_context:c},c},I.createElement=function(c,T,w){var H,N={},Z=null;if(T!=null)for(H in T.key!==void 0&&(Z=""+T.key),T)qn.call(T,H)&&H!=="key"&&H!=="__self"&&H!=="__source"&&(N[H]=T[H]);var U=arguments.length-2;if(U===1)N.children=w;else if(1<U){for(var Qn=Array(U),yn=0;yn<U;yn++)Qn[yn]=arguments[yn+2];N.children=Qn}if(c&&c.defaultProps)for(H in U=c.defaultProps,U)N[H]===void 0&&(N[H]=U[H]);return Xn(c,Z,void 0,void 0,null,N)},I.createRef=function(){return{current:null}},I.forwardRef=function(c){return{$$typeof:Wn,render:c}},I.isValidElement=Ee,I.lazy=function(c){return{$$typeof:L,_payload:{_status:-1,_result:c},_init:B}},I.memo=function(c,T){return{$$typeof:v,type:c,compare:T===void 0?null:T}},I.startTransition=function(c){var T=X.T,w={};X.T=w;try{var H=c(),N=X.S;N!==null&&N(w,H),typeof H=="object"&&H!==null&&typeof H.then=="function"&&H.then(un,k)}catch(Z){k(Z)}finally{X.T=T}},I.unstable_useCacheRefresh=function(){return X.H.useCacheRefresh()},I.use=function(c){return X.H.use(c)},I.useActionState=function(c,T,w){return X.H.useActionState(c,T,w)},I.useCallback=function(c,T){return X.H.useCallback(c,T)},I.useContext=function(c){return X.H.useContext(c)},I.useDebugValue=function(){},I.useDeferredValue=function(c,T){return X.H.useDeferredValue(c,T)},I.useEffect=function(c,T,w){var H=X.H;if(typeof w=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return H.useEffect(c,T)},I.useId=function(){return X.H.useId()},I.useImperativeHandle=function(c,T,w){return X.H.useImperativeHandle(c,T,w)},I.useInsertionEffect=function(c,T){return X.H.useInsertionEffect(c,T)},I.useLayoutEffect=function(c,T){return X.H.useLayoutEffect(c,T)},I.useMemo=function(c,T){return X.H.useMemo(c,T)},I.useOptimistic=function(c,T){return X.H.useOptimistic(c,T)},I.useReducer=function(c,T,w){return X.H.useReducer(c,T,w)},I.useRef=function(c){return X.H.useRef(c)},I.useState=function(c){return X.H.useState(c)},I.useSyncExternalStore=function(c,T,w){return X.H.useSyncExternalStore(c,T,w)},I.useTransition=function(){return X.H.useTransition()},I.version="19.1.0",I}var Py;function ar(){return Py||(Py=1,Fu.exports=Yd()),Fu.exports}var Ma=ar(),Pu={exports:{}},Sl={},$u={exports:{}},nr={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var $y;function Ld(){return $y||($y=1,function(O){function F(S,B){var k=S.length;S.push(B);n:for(;0<k;){var un=k-1>>>1,c=S[un];if(0<Y(c,B))S[un]=B,S[k]=c,k=un;else break n}}function z(S){return S.length===0?null:S[0]}function g(S){if(S.length===0)return null;var B=S[0],k=S.pop();if(k!==B){S[0]=k;n:for(var un=0,c=S.length,T=c>>>1;un<T;){var w=2*(un+1)-1,H=S[w],N=w+1,Z=S[N];if(0>Y(H,k))N<c&&0>Y(Z,H)?(S[un]=Z,S[N]=k,un=N):(S[un]=H,S[w]=k,un=w);else if(N<c&&0>Y(Z,k))S[un]=Z,S[N]=k,un=N;else break n}}return B}function Y(S,B){var k=S.sortIndex-B.sortIndex;return k!==0?k:S.id-B.id}if(O.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var V=performance;O.unstable_now=function(){return V.now()}}else{var sn=Date,Wn=sn.now();O.unstable_now=function(){return sn.now()-Wn}}var M=[],v=[],L=1,on=null,en=3,pn=!1,Yn=!1,Vn=!1,p=!1,vn=typeof setTimeout=="function"?setTimeout:null,oe=typeof clearTimeout=="function"?clearTimeout:null,dn=typeof setImmediate<"u"?setImmediate:null;function Hn(S){for(var B=z(v);B!==null;){if(B.callback===null)g(v);else if(B.startTime<=S)g(v),B.sortIndex=B.expirationTime,F(M,B);else break;B=z(v)}}function X(S){if(Vn=!1,Hn(S),!Yn)if(z(M)!==null)Yn=!0,qn||(qn=!0,Kn());else{var B=z(v);B!==null&&Gn(X,B.startTime-S)}}var qn=!1,Xn=-1,Zn=5,Ee=-1;function Na(){return p?!0:!(O.unstable_now()-Ee<Zn)}function He(){if(p=!1,qn){var S=O.unstable_now();Ee=S;var B=!0;try{n:{Yn=!1,Vn&&(Vn=!1,oe(Xn),Xn=-1),pn=!0;var k=en;try{e:{for(Hn(S),on=z(M);on!==null&&!(on.expirationTime>S&&Na());){var un=on.callback;if(typeof un=="function"){on.callback=null,en=on.priorityLevel;var c=un(on.expirationTime<=S);if(S=O.unstable_now(),typeof c=="function"){on.callback=c,Hn(S),B=!0;break e}on===z(M)&&g(M),Hn(S)}else g(M);on=z(M)}if(on!==null)B=!0;else{var T=z(v);T!==null&&Gn(X,T.startTime-S),B=!1}}break n}finally{on=null,en=k,pn=!1}B=void 0}}finally{B?Kn():qn=!1}}}var Kn;if(typeof dn=="function")Kn=function(){dn(He)};else if(typeof MessageChannel<"u"){var ha=new MessageChannel,da=ha.port2;ha.port1.onmessage=He,Kn=function(){da.postMessage(null)}}else Kn=function(){vn(He,0)};function Gn(S,B){Xn=vn(function(){S(O.unstable_now())},B)}O.unstable_IdlePriority=5,O.unstable_ImmediatePriority=1,O.unstable_LowPriority=4,O.unstable_NormalPriority=3,O.unstable_Profiling=null,O.unstable_UserBlockingPriority=2,O.unstable_cancelCallback=function(S){S.callback=null},O.unstable_forceFrameRate=function(S){0>S||125<S?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Zn=0<S?Math.floor(1e3/S):5},O.unstable_getCurrentPriorityLevel=function(){return en},O.unstable_next=function(S){switch(en){case 1:case 2:case 3:var B=3;break;default:B=en}var k=en;en=B;try{return S()}finally{en=k}},O.unstable_requestPaint=function(){p=!0},O.unstable_runWithPriority=function(S,B){switch(S){case 1:case 2:case 3:case 4:case 5:break;default:S=3}var k=en;en=S;try{return B()}finally{en=k}},O.unstable_scheduleCallback=function(S,B,k){var un=O.unstable_now();switch(typeof k=="object"&&k!==null?(k=k.delay,k=typeof k=="number"&&0<k?un+k:un):k=un,S){case 1:var c=-1;break;case 2:c=250;break;case 5:c=1073741823;break;case 4:c=1e4;break;default:c=5e3}return c=k+c,S={id:L++,callback:B,priorityLevel:S,startTime:k,expirationTime:c,sortIndex:-1},k>un?(S.sortIndex=k,F(v,S),z(M)===null&&S===z(v)&&(Vn?(oe(Xn),Xn=-1):Vn=!0,Gn(X,k-un))):(S.sortIndex=c,F(M,S),Yn||pn||(Yn=!0,qn||(qn=!0,Kn()))),S},O.unstable_shouldYield=Na,O.unstable_wrapCallback=function(S){var B=en;return function(){var k=en;en=B;try{return S.apply(this,arguments)}finally{en=k}}}}(nr)),nr}var nf;function Md(){return nf||(nf=1,$u.exports=Ld()),$u.exports}var er={exports:{}},zn={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ef;function Nd(){if(ef)return zn;ef=1;var O=ar();function F(M){var v="https://react.dev/errors/"+M;if(1<arguments.length){v+="?args[]="+encodeURIComponent(arguments[1]);for(var L=2;L<arguments.length;L++)v+="&args[]="+encodeURIComponent(arguments[L])}return"Minified React error #"+M+"; visit "+v+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function z(){}var g={d:{f:z,r:function(){throw Error(F(522))},D:z,C:z,L:z,m:z,X:z,S:z,M:z},p:0,findDOMNode:null},Y=Symbol.for("react.portal");function V(M,v,L){var on=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:Y,key:on==null?null:""+on,children:M,containerInfo:v,implementation:L}}var sn=O.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function Wn(M,v){if(M==="font")return"";if(typeof v=="string")return v==="use-credentials"?v:""}return zn.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=g,zn.createPortal=function(M,v){var L=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!v||v.nodeType!==1&&v.nodeType!==9&&v.nodeType!==11)throw Error(F(299));return V(M,v,null,L)},zn.flushSync=function(M){var v=sn.T,L=g.p;try{if(sn.T=null,g.p=2,M)return M()}finally{sn.T=v,g.p=L,g.d.f()}},zn.preconnect=function(M,v){typeof M=="string"&&(v?(v=v.crossOrigin,v=typeof v=="string"?v==="use-credentials"?v:"":void 0):v=null,g.d.C(M,v))},zn.prefetchDNS=function(M){typeof M=="string"&&g.d.D(M)},zn.preinit=function(M,v){if(typeof M=="string"&&v&&typeof v.as=="string"){var L=v.as,on=Wn(L,v.crossOrigin),en=typeof v.integrity=="string"?v.integrity:void 0,pn=typeof v.fetchPriority=="string"?v.fetchPriority:void 0;L==="style"?g.d.S(M,typeof v.precedence=="string"?v.precedence:void 0,{crossOrigin:on,integrity:en,fetchPriority:pn}):L==="script"&&g.d.X(M,{crossOrigin:on,integrity:en,fetchPriority:pn,nonce:typeof v.nonce=="string"?v.nonce:void 0})}},zn.preinitModule=function(M,v){if(typeof M=="string")if(typeof v=="object"&&v!==null){if(v.as==null||v.as==="script"){var L=Wn(v.as,v.crossOrigin);g.d.M(M,{crossOrigin:L,integrity:typeof v.integrity=="string"?v.integrity:void 0,nonce:typeof v.nonce=="string"?v.nonce:void 0})}}else v==null&&g.d.M(M)},zn.preload=function(M,v){if(typeof M=="string"&&typeof v=="object"&&v!==null&&typeof v.as=="string"){var L=v.as,on=Wn(L,v.crossOrigin);g.d.L(M,L,{crossOrigin:on,integrity:typeof v.integrity=="string"?v.integrity:void 0,nonce:typeof v.nonce=="string"?v.nonce:void 0,type:typeof v.type=="string"?v.type:void 0,fetchPriority:typeof v.fetchPriority=="string"?v.fetchPriority:void 0,referrerPolicy:typeof v.referrerPolicy=="string"?v.referrerPolicy:void 0,imageSrcSet:typeof v.imageSrcSet=="string"?v.imageSrcSet:void 0,imageSizes:typeof v.imageSizes=="string"?v.imageSizes:void 0,media:typeof v.media=="string"?v.media:void 0})}},zn.preloadModule=function(M,v){if(typeof M=="string")if(v){var L=Wn(v.as,v.crossOrigin);g.d.m(M,{as:typeof v.as=="string"&&v.as!=="script"?v.as:void 0,crossOrigin:L,integrity:typeof v.integrity=="string"?v.integrity:void 0})}else g.d.m(M)},zn.requestFormReset=function(M){g.d.r(M)},zn.unstable_batchedUpdates=function(M,v){return M(v)},zn.useFormState=function(M,v,L){return sn.H.useFormState(M,v,L)},zn.useFormStatus=function(){return sn.H.useHostTransitionStatus()},zn.version="19.1.0",zn}var af;function Kd(){if(af)return er.exports;af=1;function O(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(O)}catch(F){console.error(F)}}return O(),er.exports=Nd(),er.exports}/**
 * @license React
...
まだまだやれるで！
テッペンテッペンテッペンテッペンの
大勝負！`},{id:2,title:"バンザイ夢マンサイ!",titleKana:"ばんざいゆめまんさい",lyricist:"zopp",composer:"川口進・Joakim Bjornbeg・Christofer Erixon",arranger:"CHOKKAKU",album:["ええじゃないか","ええじゃないか[初回盤]","ええじゃないか[通常盤]","go WEST よーいドン！","go WEST よーいドン！[通常盤]"],announce:"t",singer:"WEST.",date:"2014-04-23",tiup:"映画『忍ジャニ参上！未来への戦い』エンディングテーマ",lyrics:`人生はバンザイ！　夢マンサイ！
泣いたり笑たりでGO!!
酸いも甘いも　抱きしめ　笑い飛ばして
ほんまサンキューサンキュー！
...
隠す　お気に入りの一輪
舞い上がる風に託すよ
いつまでも愛に満ちた日々を`}],zd=({song:O,onClose:F})=>{if(!O)return null;const z=Y=>Y==="t"?"披露あり":Y==="f"?"未披露":"不明",g=O.album.filter(Y=>Y.includes("[")&&Y.includes("]"));return W.jsx("div",{className:"modal-overlay",onClick:F,children:W.jsxs("div",{className:"modal-content",onClick:Y=>Y.stopPropagation(),children:[W.jsx("h2",{children:O.title}),W.jsxs("p",{children:[W.jsx("strong",{children:"作詞者:"})," ",W.jsx("span",{className:"modal-item-value",children:O.lyricist})]}),"   ",W.jsxs("p",{children:[W.jsx("strong",{children:"作曲者:"})," ",W.jsx("span",{className:"modal-item-value",children:O.composer})]})," ",O.arranger&&W.jsxs("p",{children:[W.jsx("strong",{children:"編曲者:"})," ",W.jsx("span",{className:"modal-item-value",children:O.arranger})]}),O.brassarrange&&W.jsxs("p",{children:[W.jsx("strong",{children:"ブラスアレンジ:"})," ",W.jsx("span",{className:"modal-item-value",children:O.brassarrange})]}),O.produce&&W.jsxs("p",{children:[W.jsx("strong",{children:"プロデュース:"})," ",W.jsx("span",{className:"modal-item-value",children:O.produce})]}),O.stringsarrange&&W.jsxs("p",{children:[W.jsx("strong",{children:"ストリングスアレンジ:"})," ",W.jsx("span",{className:"modal-item-value",children:O.stringsarrange})]}),O.translate&&W.jsxs("p",{children:[W.jsx("strong",{children:"英訳詞:"})," ",W.jsx("span",{className:"modal-item-value",children:O.translate})]}),W.jsxs("p",{children:[W.jsx("strong",{children:"ユニット:"})," ",W.jsx("span",{className:"modal-item-value",children:O.singer||"WEST."})]})," ",W.jsxs("p",{children:[W.jsx("strong",{children:"発売日:"})," ",W.jsx("span",{className:"modal-item-value",children:O.date})]}),"      ",O.tiup&&W.jsxs("p",{children:[W.jsx("strong",{children:"タイアップ:"})," ",W.jsx("span",{className:"modal-item-value",children:O.tiup})]}),W.jsx("p",{children:W.jsx("strong",{children:"収録シングル/アルバム:"})}),W.jsxs("ul",{children:[g.map((Y,V)=>W.jsx("li",{children:W.jsx("span",{className:"modal-item-value",children:Y})},V)),g.length===0&&W.jsx("li",{children:W.jsx("span",{className:"modal-item-value",children:"[]付きの収録はありません"})})]}),W.jsxs("p",{children:[W.jsx("strong",{children:"披露情報:"})," ",W.jsx("span",{className:"modal-item-value",children:z(O.announce)})]})," ",O.lyrics&&W.jsxs("div",{className:"lyrics-section",children:[" ",W.jsx("h3",{children:"歌詞"}),W.jsx("p",{className:"modal-lyrics-text",children:O.lyrics})," "]}),W.jsx("button",{onClick:F,className:"modal-close-button",children:"閉じる"})]})})},Ud=["タイトル","作詞者","作曲者","編曲者","歌詞","収録","披露","ユニット","タイアップ"];function Id(){const[O,F]=Ma.useState(""),[z,g]=Ma.useState("タイトル"),[Y,V]=Ma.useState("name_asc"),[sn,Wn]=Ma.useState(null),[M,v]=Ma.useState(!1);Ma.useEffect(()=>{F("")},[z]);const L=["ええじゃないか","ええじゃないか[初回盤]","ええじゃないか[MY BEST CD盤]","ええじゃないか[通常盤]","go WEST よーいドン！","go WEST よーいドン！[初回盤]","go WEST よーいドン！[通常盤]","ジパング・おおきに大作戦/夢を抱きしめて","ジパング・おおきに大作戦/夢を抱きしめて[初回A]","ジパング・おおきに大作戦/夢を抱きしめて[初回B]","ジパング・おおきに大作戦/夢を抱きしめて[初回C]","ジパング・おおきに大作戦/夢を抱きしめて[通常盤]","ズンドコ パラダイス","ズンドコ パラダイス[初回A]","ズンドコ パラダイス[初回B]","ズンドコ パラダイス[通常盤]","パリピポ","パリピポ[初回盤]","パリピポ[通常盤]","バリ ハピ","バリ ハピ[初回A]","バリ ハピ[初回B]","バリ ハピ[通常盤]","ラッキィィィィィィィ7","ラッキィィィィィィィ7[初回盤]","ラッキィィィィィィィ7[通常盤]","逆転Winner","逆転Winner[初回A]","逆転Winner[初回B]","逆転Winner[通常盤]","人生は素晴らしい","人生は素晴らしい[初回A]","人生は素晴らしい[初回B]","人生は素晴らしい[通常盤]","なうぇすと","なうぇすと[初回盤]","なうぇすと[通常盤]","おーさか☆愛・EYE・哀/Ya! Hot! Hot!","おーさか☆愛・EYE・哀/Ya! Hot! Hot![初回A]","おーさか☆愛・EYE・哀/Ya! Hot! Hot![初回B]","おーさか☆愛・EYE・哀/Ya! Hot! Hot![通常盤]","僕ら今日も生きている/考えるな、燃えろ!!","僕ら今日も生きている/考えるな、燃えろ!![初回A]","僕ら今日も生きている/考えるな、燃えろ!![初回B]","僕ら今日も生きている/考えるな、燃えろ!![通常盤]","WESTival","WESTival[初回盤]","WESTival[通常盤]","プリンシパルの君へ/ドラゴンドッグ","プリンシパルの君へ/ドラゴンドッグ[初回A]","プリンシパルの君へ/ドラゴンドッグ[初回B]","プリンシパルの君へ/ドラゴンドッグ[通常盤]","スタートダッシュ!","スタートダッシュ![初回A]","スタートダッシュ![初回B]","スタートダッシュ![通常盤]","WESTV！","WESTV！[初回盤]","WESTV！[通常盤]","ホメチギリスト/傷だらけの愛","ホメチギリスト/傷だらけの愛[初回A]","ホメチギリスト/傷だらけの愛[初回B]","ホメチギリスト/傷だらけの愛[通常盤]","アメノチハレ","アメノチハレ[初回A]","アメノチハレ[初回B]","アメノチハレ[通常盤]","Big Shot!!","Big Shot!![初回A]","Big Shot!![初回B]","Big Shot!![通常盤]","W trouble","W trouble[初回A]","W trouble[初回B]","W trouble[通常盤]","W trouble[通販盤]","証拠","証拠[初回A]","証拠[初回B]","証拠[通常盤]","週刊うまくいく曜日","週刊うまくいく曜日[初回A]","週刊うまくいく曜日[初回B]","週刊うまくいく曜日[通常盤]","rainboW","rainboW[初回A]","rainboW[初回B]","rainboW[通常盤]","rainboW[通販盤]","サムシング・ニュー","サムシング・ニュー[初回A]","サムシング・ニュー[初回B]","サムシング・ニュー[通常盤]","でっかい愛/喜努愛楽","でっかい愛/喜努愛楽[初回A]","でっかい愛/喜努愛楽[初回B]","でっかい愛/喜努愛楽[通常盤]","黎明/進むしかねぇ","黎明/進むしかねぇ[初回A]","黎明/進むしかねぇ[初回B]","黎明/進むしかねぇ[通常盤]","Mixed Juice","Mixed Juice[初回A]","Mixed Juice[初回B]","Mixed Juice[通常盤]","星の雨","星の雨[初回A]","星の雨[初回B]","星の雨[通常盤]","星の雨[通販盤]","POWER","POWER[初回A]","POWER[初回B]","POWER[通常盤]","POWER[通販盤]","しあわせの花","しあわせの花[初回A]","しあわせの花[初回B]","しあわせの花[通常盤]","しあわせの花[通販盤]","絶体絶命 / Beautiful / AS ONE","絶体絶命 / Beautiful / AS ONE[初回A]","絶体絶命 / Beautiful / AS ONE[初回B]","絶体絶命 / Beautiful / AS ONE[初回C]","絶体絶命 / Beautiful / AS ONE[通常盤]","AWARD","AWARD[初回A]","AWARD[初回B]","AWARD[通常盤]","ハート / FATE","ハート / FATE[初回A]","ハート / FATE[初回B]","ハート / FATE[通常盤]","ハート / FATE[通販盤]","まぁいっか！","まぁいっか！[初回A]","まぁいっか！[初回B]","まぁいっか！[通常盤]","A.H.O. -Audio Hang Out-","A.H.O. -Audio Hang Out-[初回A]","A.H.O. -Audio Hang Out-[初回B]","A.H.O. -Audio Hang Out-[通常盤]","ウェッサイソウル！ / BIG LOVE SONG","ウェッサイソウル！ / BIG LOVE SONG[初回A]","ウェッサイソウル！ / BIG LOVE SONG[初回B]","ウェッサイソウル！ / BIG LOVE SONG[通常盤]"],on=Array.from(new Set(of.map(p=>p.singer).filter(Boolean))),en=[{label:"⇅ 名前順(あ→わ)",value:"name_asc"},{label:"⇅ 名前順(わ→あ)",value:"name_desc"},{label:"⇅ 古い曲順",value:"date_asc"},{label:"⇅ 新しい曲順",value:"date_desc"}],pn=of.filter(p=>{const vn=O.toLowerCase();return z==="タイトル"?p.title.toLowerCase().includes(vn):z==="作詞者"?p.lyricist.toLowerCase().includes(vn):z==="作曲者"?p.composer.toLowerCase().includes(vn):z==="編曲者"?p.arranger.toLowerCase().includes(vn):z==="歌詞"?p.lyrics.toLowerCase().includes(vn):z==="収録"?O===""||p.album.includes(O):z==="披露"?O==="披露あり"?p.announce=="t":O==="未披露"?p.announce==="f":!0:z==="ユニット"?O===""||p.singer===O:z==="タイアップ"?O==="あり"?p.tiup&&p.tiup.trim()!=="":O==="なし"?!p.tiup||p.tiup.trim()==="":!0:!0}).sort((p,vn)=>{const oe=dn=>{const Hn=dn.charAt(0);return Hn.match(/^[\u3040-\u30FF]/)?0:Hn.match(/^[a-zA-Z]/)?1:2};if(Y==="name_asc"||Y==="name_desc"){const dn=oe(p.titleKana),Hn=oe(vn.titleKana);return dn!==Hn?Y==="name_asc"?dn-Hn:Hn-dn:Y==="name_asc"?p.titleKana.localeCompare(vn.titleKana,"ja",{sensitivity:"base"}):vn.titleKana.localeCompare(p.titleKana,"ja",{sensitivity:"base"})}return Y==="date_asc"?new Date(p.date)-new Date(vn.date):Y==="date_desc"?new Date(vn.date)-new Date(p.date):0}),Yn=p=>{Wn(p),v(!0)},Vn=()=>{v(!1),Wn(null)};return W.jsxs("div",{className:"container",children:[W.jsx("h1",{children:"WEST. 楽曲リスト"}),W.jsxs("div",{className:"controls",children:[W.jsx("select",{value:z,onChange:p=>g(p.target.value),children:Ud.map(p=>W.jsx("option",{value:p,children:p},p))}),z==="収録"?W.jsxs("select",{value:O,onChange:p=>F(p.target.value),children:[W.jsx("option",{value:"",children:"すべての収録"}),L.map(p=>W.jsx("option",{value:p,children:p},p))]}):z==="ユニット"?W.jsxs("select",{value:O,onChange:p=>F(p.target.value),children:[W.jsx("option",{value:"",children:"すべてのユニット"}),on.map(p=>W.jsx("option",{value:p,children:p},p))]}):z==="披露"?W.jsxs("select",{value:O,onChange:p=>F(p.target.value),children:[W.jsx("option",{value:"",children:"すべての曲"}),W.jsx("option",{value:"披露あり",children:"披露あり"}),W.jsx("option",{value:"未披露",children:"未披露"})]}):z==="タイアップ"?W.jsxs("select",{value:O,onChange:p=>F(p.target.value),children:[W.jsx("option",{value:"",children:"すべて"})," ",W.jsx("option",{value:"あり",children:"あり"}),W.jsx("option",{value:"なし",children:"なし"})]}):W.jsx("input",{type:"text",placeholder:`${z}で検索...`,value:O,onChange:p=>F(p.target.value)}),W.jsx("select",{value:Y,onChange:p=>V(p.target.value),children:en.map(p=>W.jsx("option",{value:p.value,children:p.label},p.value))})]}),W.jsxs("div",{style:{marginBottom:"0.5rem",fontSize:"0.9rem"},children:[pn.length," 件の曲が見つかりました"]}),W.jsx("div",{className:"song-list-wrapper",children:W.jsxs("div",{className:"song-list",children:[W.jsxs("div",{className:"song-header",children:[W.jsx("span",{children:"タイトル"}),W.jsx("span",{children:"作詞者"}),W.jsx("span",{children:"作曲者"}),W.jsx("span",{children:"初収録"}),W.jsx("span",{children:"発売日"})]}),pn.map(p=>W.jsxs("div",{className:"song-card",onClick:()=>Yn(p),children:[W.jsx("span",{className:"song-title",children:p.title}),W.jsx("span",{children:p.lyricist}),W.jsx("span",{children:p.composer}),W.jsx("span",{children:p.album[0]}),W.jsx("span",{className:"song-date",children:p.date})]},p.id))]})}),M&&sn&&W.jsx(zd,{song:sn,onClose:Vn})]})}Cd.createRoot(document.getElementById("root")).render(W.jsx(Ma.StrictMode,{children:W.jsx(Id,{})}));
