export const songs = [
    ...
    {          
        ...
        announce: "t",
        performances:["なにわともあれ、ほんまにありがとう！{4}","一発めぇぇぇぇぇぇぇ！{8}","一発めぇぇぇぇぇぇぇ！(各会場オーラス){8}","一発めぇぇぇぇぇぇぇ！(大阪オーラス){8}","パリピポ(兵庫オーラス){28}","なうぇすと(〜横浜3日目){20}","なうぇすと(横浜4日目〜,福井,福岡,宮城,愛知,静岡,大阪,北海道,広島){20}","なうぇすと(各会場オーラス){20}","なうぇすと(広島オーラス){20}",],
        singer: "WEST.",
        date: "2014-04-23",
    ...
    },
    {
        ...
        announce: "t",
        performances:["なにわともあれ、ほんまにありがとう！{3}","一発めぇぇぇぇぇぇぇ！{13}","一発めぇぇぇぇぇぇぇ！(各会場オーラス){13}","一発めぇぇぇぇぇぇぇ！(大阪オーラス){13}","rainboW(円盤){32}",],
        singer: "WEST.",
        date: "2014-04-23",
    ...
    },
    {
        ...
        album: ["ええじゃないか","ええじゃないか[通常盤]","go WEST よーいドン！","go WEST よーいドン！[初回盤]","go WEST よーいドン！[通常盤]"],
        announce: "t",
        performances:["なにわともあれ、ほんまにありがとう！{2}","一発めぇぇぇぇぇぇぇ！{17}","一発めぇぇぇぇぇぇぇ！(各会場オーラス){17}","一発めぇぇぇぇぇぇぇ！(大阪オーラス){17}","パリピポ{11}","パリピポ(各会場オーラス){11}","パリピポ(兵庫オーラス){11}","ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟){13}","ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟のオーラス){13}","ラッキィィィィィィィ7(大阪,宮城){13}","ラッキィィィィィィィ7(大阪オーラス){13}","ラッキィィィィィィィ7(宮城オーラス){13}","24(ニシ)から感謝届けます♡{11}","24(ニシ)から感謝届けます♡(オーラス){11}",],
        singer: "WEST.",
        date: "2014-04-23",
    ...
    },
    {
        ...
        announce: "t",
        performances:["なにわともあれ、ほんまにありがとう！{13}","一発めぇぇぇぇぇぇぇ！{18}","一発めぇぇぇぇぇぇぇ！(各会場オーラス){18}","一発めぇぇぇぇぇぇぇ！(大阪オーラス){18}","パリピポ{13}","パリピポ(各会場オーラス){13}","パリピポ(兵庫オーラス){13}",],
        singer: "WEST.",
        date: "2014-04-23",
    ...
    },
    {
        ...
        album: ["ええじゃないか","ええじゃないか[MY BEST CD盤]"],
        announce: "t",
        performances:["なにわともあれ、ほんまにありがとう！{9}","一発めぇぇぇぇぇぇぇ！{12}","一発めぇぇぇぇぇぇぇ！(各会場オーラス){12}","一発めぇぇぇぇぇぇぇ！(大阪オーラス){12}",],
        singer: "WEST.",
        date: "2014-04-23",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["一発めぇぇぇぇぇぇぇ！{4}","一発めぇぇぇぇぇぇぇ！(各会場オーラス){4}","一発めぇぇぇぇぇぇぇ！(大阪オーラス){4}","パリピポ{15}","パリピポ(各会場オーラス){15}","パリピポ(兵庫オーラス){15}",],
        singer: "WEST.",
        date: "2014-08-06",
    ...
    },
    {
        ...
        album: ["go WEST よーいドン！","go WEST よーいドン！[初回盤]","go WEST よーいドン！[通常盤]"],
        announce: "t",
        performances:["なにわともあれ、ほんまにありがとう！{8}"],
        singer: "WEST.",
        date: "2014-08-06",
    ...
    },
    {
        ...
        album: ["go WEST よーいドン！","go WEST よーいドン！[初回盤]","go WEST よーいドン！[通常盤]"],
        announce: "t",
        performances:["なにわともあれ、ほんまにありがとう！{6}","一発めぇぇぇぇぇぇぇ！{10}","一発めぇぇぇぇぇぇぇ！(各会場オーラス){10}","一発めぇぇぇぇぇぇぇ！(大阪オーラス){10}",],
        singer: "WEST.",
        date: "2014-08-06",
    ...
    },
    {
        ...
        announce: "t",
        performances:["なにわともあれ、ほんまにありがとう！{7}","パリピポ{25}","パリピポ(各会場オーラス){25}","パリピポ(兵庫オーラス){25}","ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟){10}","ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟のオーラス){10}","ラッキィィィィィィィ7(大阪,宮城){10}","ラッキィィィィィィィ7(大阪オーラス){10}","ラッキィィィィィィィ7(宮城オーラス){10}",],
        singer: "WEST.",
        date: "2014-08-06",
    ...
    },
    {
        ...
        album: ["go WEST よーいドン！","go WEST よーいドン！[初回盤]","go WEST よーいドン！[通常盤]"],
        announce: "t",
        performances:["なにわともあれ、ほんまにありがとう！{10}","一発めぇぇぇぇぇぇぇ！{5}","一発めぇぇぇぇぇぇぇ！(各会場オーラス){5}","一発めぇぇぇぇぇぇぇ！(大阪オーラス){5}",],
        singer: "WEST.",
        date: "2014-08-06",
    ...
    },
    {
        ...
        album: ["go WEST よーいドン！","go WEST よーいドン！[初回盤]","go WEST よーいドン！[通常盤]"],
        announce: "t",
        performances:["なにわともあれ、ほんまにありがとう！{11}","一発めぇぇぇぇぇぇぇ！{15}","一発めぇぇぇぇぇぇぇ！(各会場オーラス){15}","一発めぇぇぇぇぇぇぇ！(大阪オーラス){15}","パリピポ{16}","パリピポ(各会場オーラス){16}","パリピポ(兵庫オーラス){16}","24(ニシ)から感謝届けます♡{7}","24(ニシ)から感謝届けます♡(オーラス){7}","TO BE KANSAI COLOR-翔べ関西から-(大阪){20}","TO BE KANSAI COLOR-翔べ関西から-(名古屋){19}",],
        singer: "WEST.",
        date: "2014-08-06",
    ...
    },
    {
        ...
        album: ["go WEST よーいドン！","go WEST よーいドン！[初回盤]","go WEST よーいドン！[通常盤]"],
        announce: "t",
        performances:["なにわともあれ、ほんまにありがとう！{12}","一発めぇぇぇぇぇぇぇ！{16}","一発めぇぇぇぇぇぇぇ！(各会場オーラス){16}","一発めぇぇぇぇぇぇぇ！(大阪オーラス){16}","パリピポ{23}","パリピポ(各会場オーラス){23}","パリピポ(兵庫オーラス){23}","ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟){3}","ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟のオーラス){3}","ラッキィィィィィィィ7(大阪,宮城){3}","ラッキィィィィィィィ7(大阪オーラス){3}","ラッキィィィィィィィ7(宮城オーラス){3}","24(ニシ)から感謝届けます♡{21}","24(ニシ)から感謝届けます♡(オーラス){21}","なうぇすと(各会場オーラス){31}","なうぇすと(広島オーラス){31}","WESTival(北海道オーラス){29}","WESTV!{14}","WESTV!(各会場オーラス){14}","WESTV!(北海道オーラス){14}","TO BE KANSAI COLOR-翔べ関西から-(東京オーラス){35}",],
        singer: "WEST.",
        date: "2014-08-06",
    ...
    },
    {
        ...
        album: ["go WEST よーいドン！","go WEST よーいドン！[通常盤]"],
        announce: "t",
        performances: ["一発めぇぇぇぇぇぇぇ！{19}","一発めぇぇぇぇぇぇぇ！(各会場オーラス){19}","一発めぇぇぇぇぇぇぇ！(大阪オーラス){19}","ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟){12}","ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟のオーラス){12}","ラッキィィィィィィィ7(大阪,宮城){12}","ラッキィィィィィィィ7(大阪オーラス){12}","ラッキィィィィィィィ7(宮城オーラス){12}",],
        singer: "WEST.",
        date: "2014-08-06",
    ...
    },
    {
        ...
        album: ["ジパング・おおきに大作戦/夢を抱きしめて","ジパング・おおきに大作戦/夢を抱きしめて[初回A]","ジパング・おおきに大作戦/夢を抱きしめて[初回B]","ジパング・おおきに大作戦/夢を抱きしめて[初回C]","ジパング・おおきに大作戦/夢を抱きしめて[通常盤]","ラッキィィィィィィィ7","ラッキィィィィィィィ7[初回盤]","ラッキィィィィィィィ7[通常盤]","AWARD","AWARD[初回A]","AWARD[初回B]","AWARD[通常盤]"],
        announce: "t",
        performances: ["一発めぇぇぇぇぇぇぇ！{11}","一発めぇぇぇぇぇぇぇ！(各会場オーラス){11}","一発めぇぇぇぇぇぇぇ！(大阪オーラス){11}","パリピポ{5}","パリピポ(各会場オーラス){5}","パリピポ(兵庫オーラス){5}","なうぇすと(〜横浜3日目){22}","なうぇすと(横浜4日目〜,福井,福岡,宮城,愛知,静岡,大阪,北海道,広島){22}","なうぇすと(各会場オーラス){22}","なうぇすと(広島オーラス){22}",],
        singer: "WEST.",
        date: "2014-10-08",
    ...
    },
    {
        ...
        album: ["ジパング・おおきに大作戦/夢を抱きしめて","ジパング・おおきに大作戦/夢を抱きしめて[初回C]"],
        announce: "t",
        performances: ["一発めぇぇぇぇぇぇぇ！{6}","一発めぇぇぇぇぇぇぇ！(各会場オーラス){6}","一発めぇぇぇぇぇぇぇ！(大阪オーラス){6}","パリピポ{7}","パリピポ(各会場オーラス){7}","パリピポ(兵庫オーラス){7}","24(ニシ)から感謝届けます♡{6}","24(ニシ)から感謝届けます♡(オーラス){6}","TO BE KANSAI COLOR-翔べ関西から-(大阪){19}","TO BE KANSAI COLOR-翔べ関西から-(名古屋){18}",],
        singer: "WEST.",
        date: "2014-10-08",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["一発めぇぇぇぇぇぇぇ！{14}","一発めぇぇぇぇぇぇぇ！(各会場オーラス){14}","一発めぇぇぇぇぇぇぇ！(大阪オーラス){14}","パリピポ{14}","パリピポ(各会場オーラス){14}","パリピポ(兵庫オーラス){14}",],
        singer: "WEST.",
        date: "2014-10-08",
    ...
    },
    {
        ...
        album: ["ジパング・おおきに大作戦/夢を抱きしめて","ジパング・おおきに大作戦/夢を抱きしめて[通常盤]"],
        announce: "t",
        performances: ["パリピポ{22}","パリピポ(各会場オーラス){22}","パリピポ(兵庫オーラス){22}","TO BE KANSAI COLOR-翔べ関西から-(大阪){1}","TO BE KANSAI COLOR-翔べ関西から-(名古屋){1}","TO BE KANSAI COLOR-翔べ関西から-(東京){1}","TO BE KANSAI COLOR-翔べ関西から-(東京オーラス){1}",],
        singer: "WEST.",
        date: "2014-10-08",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["一発めぇぇぇぇぇぇぇ！{9}","一発めぇぇぇぇぇぇぇ！(各会場オーラス){9}","一発めぇぇぇぇぇぇぇ！(大阪オーラス){9}","パリピポ{2}","パリピポ(各会場オーラス){2}","パリピポ(兵庫オーラス){2}","ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟){23}","ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟のオーラス){23}","ラッキィィィィィィィ7(大阪,宮城){24}","ラッキィィィィィィィ7(大阪オーラス){24}","ラッキィィィィィィィ7(宮城オーラス){24}","24(ニシ)から感謝届けます♡{2}","24(ニシ)から感謝届けます♡(オーラス){2}","なうぇすと(〜横浜3日目){25}","なうぇすと(横浜4日目〜,福井,福岡,宮城,愛知,静岡,大阪,北海道,広島){25}","なうぇすと(各会場オーラス){25}","なうぇすと(広島オーラス){25}","WESTival{3}","WESTival(各会場オーラス){3}","WESTival(北海道オーラス){3}","WESTV!{11}","WESTV!(各会場オーラス){11}","WESTV!(北海道オーラス){11}","W trouble12/12夜,12/13昼{23}","rainboW(北海道){26}","rainboW(宮城,愛知,新潟,埼玉,熊本){27}","rainboW(円盤){27}","Mixed Juice(静岡3/20,熊本3/26,宮城4/1,宮城4/2,愛知4/10,愛知4/15,横浜4/28,北海道6/10){26}","Mixed Juice(静岡3/21,熊本3/27,宮城4/3,愛知4/9,大阪4/16,大阪4/17,横浜4/27昼,横浜4/29昼,横浜4/30,城ホ5/5昼,新潟5/15昼,北海道6/11){26}","Mixed Juice(横浜4/27夜,横浜5/1夜,城ホ5/5夜,新潟5/15夜,北海道6/12夜){26}","Mixed Juice(横浜4/29夜,横浜5/1昼,城ホ5/4,新潟5/16,北海道6/12昼){26}","Mixed Juice(北海道オーラス){26}","TO BE KANSAI COLOR-翔べ関西から-(大阪){37}","TO BE KANSAI COLOR-翔べ関西から-(名古屋){34}","TO BE KANSAI COLOR-翔べ関西から-(東京){32}","TO BE KANSAI COLOR-翔べ関西から-(東京オーラス){32}",],
        singer: "WEST.",
        date: "2015-02-04",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["パリピポ{1}","パリピポ(各会場オーラス){1}","パリピポ(兵庫オーラス){1}","ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟){11}","ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟のオーラス){11}","ラッキィィィィィィィ7(大阪,宮城){11}","ラッキィィィィィィィ7(大阪オーラス){11}","ラッキィィィィィィィ7(宮城オーラス){11}","24(ニシ)から感謝届けます♡{24}","24(ニシ)から感謝届けます♡(オーラス){24}",],
        singer: "WEST.",
        date: "2015-02-04",
    ...
    },
    {
        ...
        album: ["ズンドコ パラダイス","ズンドコ パラダイス[通常盤]"],
        announce: "t",
        performances: ["パリピポ{24}","パリピポ(各会場オーラス){24}","パリピポ(兵庫オーラス){24}",],
        singer: "WEST.",
        date: "2015-02-04",
    ...
    },
    {
        ...
        album: ["パリピポ","パリピポ[初回盤]","パリピポ[通常盤]"],
        announce: "t",
        performances: ["パリピポ{19}","パリピポ(各会場オーラス){19}","パリピポ(兵庫オーラス){19}",],
        singer: "WEST.",
        date: "2015-04-22",
    ...
    },
    {
        ...
        album: ["パリピポ","パリピポ[初回盤]","パリピポ[通常盤]"],
        announce: "t",
        performances: ["パリピポ{18}","パリピポ(各会場オーラス){18}","パリピポ(兵庫オーラス){18}",],
        singer: "WEST.",
        date: "2015-04-22",
    ...
    },
    {
        ...
        album: ["パリピポ","パリピポ[初回盤]","パリピポ[通常盤]"],
        announce: "t",
        performances: ["パリピポ{6}","パリピポ(各会場オーラス){6}","パリピポ(兵庫オーラス){6}","24(ニシ)から感謝届けます♡{5}","24(ニシ)から感謝届けます♡(オーラス){5}",],
        singer: "WEST.",
        date: "2015-04-22",
    ...
    },
    {
        ...
        album: ["パリピポ","パリピポ[初回盤]","パリピポ[通常盤]"],
        announce: "t",
        performances: ["パリピポ{10}","パリピポ(各会場オーラス){10}","パリピポ(兵庫オーラス){10}","ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟){14}","ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟のオーラス){14}","ラッキィィィィィィィ7(大阪,宮城){14}","ラッキィィィィィィィ7(大阪オーラス){14}","ラッキィィィィィィィ7(宮城オーラス){14}","24(ニシ)から感謝届けます♡{16}","24(ニシ)から感謝届けます♡(オーラス){16}","なうぇすと(〜横浜3日目){14}","なうぇすと(横浜4日目〜,福井,福岡,宮城,愛知,静岡,大阪,北海道,広島){14}","なうぇすと(各会場オーラス){14}","なうぇすと(広島オーラス){14}","WESTival{17}","WESTival(各会場オーラス){17}","WESTival(北海道オーラス){17}","WESTV!{20}","WESTV!(各会場オーラス){20}","WESTV!(北海道オーラス){20}","W trouble12/11{20}","W trouble12/12昼,12/13夜{20}","W trouble12/12夜,12/13昼{20}","rainboW(宮城,愛知,新潟,埼玉,熊本){26}","rainboW(円盤){26}","Mixed Juice(静岡3/20,熊本3/26,宮城4/1,宮城4/2,愛知4/10,愛知4/15,横浜4/28,北海道6/10){25}","Mixed Juice(静岡3/21,熊本3/27,宮城4/3,愛知4/9,大阪4/16,大阪4/17,横浜4/27昼,横浜4/29昼,横浜4/30,城ホ5/5昼,新潟5/15昼,北海道6/11){25}","Mixed Juice(横浜4/27夜,横浜5/1夜,城ホ5/5夜,新潟5/15夜,北海道6/12夜){25}","Mixed Juice(横浜4/29夜,横浜5/1昼,城ホ5/4,新潟5/16,北海道6/12昼){25}","Mixed Juice(北海道オーラス){25}","TO BE KANSAI COLOR-翔べ関西から-(大阪){26}","TO BE KANSAI COLOR-翔べ関西から-(名古屋){25}","TO BE KANSAI COLOR-翔べ関西から-(東京){23}","TO BE KANSAI COLOR-翔べ関西から-(東京オーラス){23}",],
        singer: "WEST.",
        date: "2015-04-22",
    ...
    },
    {
        ...
        album: ["ラッキィィィィィィィ7","ラッキィィィィィィィ7[初回盤]","ラッキィィィィィィィ7[通常盤]"],
        announce: "t",
        performances: ["ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟){20}","ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟のオーラス){20}","ラッキィィィィィィィ7(大阪,宮城){21}","ラッキィィィィィィィ7(大阪オーラス){21}","ラッキィィィィィィィ7(宮城オーラス){21}","24(ニシ)から感謝届けます♡{17}","24(ニシ)から感謝届けます♡(オーラス){17}","なうぇすと(〜横浜3日目){15}","なうぇすと(横浜4日目〜,福井,福岡,宮城,愛知,静岡,大阪,北海道,広島){15}","なうぇすと(各会場オーラス){15}","なうぇすと(広島オーラス){15}","WESTival{16}","WESTival(各会場オーラス){16}","WESTival(北海道オーラス){16}","TO BE KANSAI COLOR-翔べ関西から-(大阪){28}","TO BE KANSAI COLOR-翔べ関西から-(名古屋){27}","TO BE KANSAI COLOR-翔べ関西から-(東京){25}","TO BE KANSAI COLOR-翔べ関西から-(東京オーラス){25}",],
        singer: "WEST.",
        date: "2015-12-09",
    ...
    },
    {
        ...
        album: ["ラッキィィィィィィィ7","ラッキィィィィィィィ7[初回盤]","ラッキィィィィィィィ7[通常盤]"],
        announce: "t",
        performances: ["ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟){7}","ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟のオーラス){7}","ラッキィィィィィィィ7(大阪,宮城){7}","ラッキィィィィィィィ7(大阪オーラス){7}","ラッキィィィィィィィ7(宮城オーラス){7}",],
        singer: "WEST.",
        date: "2015-12-09",
    ...
    },
    {
        ...
        album: ["ラッキィィィィィィィ7","ラッキィィィィィィィ7[通常盤]"],
        announce: "t",
        performances: ["ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟){16}","ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟のオーラス){16}","ラッキィィィィィィィ7(大阪,宮城){17}","ラッキィィィィィィィ7(大阪オーラス){17}","ラッキィィィィィィィ7(宮城オーラス){17}","24(ニシ)から感謝届けます♡{13}","24(ニシ)から感謝届けます♡(オーラス){13}",],
        singer: "重岡大毅＆神山智洋",
        date: "2015-12-09",
    ...
    { 
        ...
        album: ["ラッキィィィィィィィ7","ラッキィィィィィィィ7[通常盤]"],
        announce: "t",
        performances: ["ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟){4}","ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟のオーラス){4}","ラッキィィィィィィィ7(大阪,宮城){4}","ラッキィィィィィィィ7(大阪オーラス){4}","ラッキィィィィィィィ7(宮城オーラス){4}",],
        singer: "藤井流星＆小瀧望",
        date: "2015-12-09",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["なうぇすと(〜横浜3日目){4}","なうぇすと(横浜4日目〜,福井,福岡,宮城,愛知,静岡,大阪,北海道,広島){4}","なうぇすと(各会場オーラス){4}","なうぇすと(広島オーラス){4}",],
        singer: "WEST.",
        date: "2016-04-20",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["24(ニシ)から感謝届けます♡{23}","24(ニシ)から感謝届けます♡(オーラス){23}","なうぇすと(〜横浜3日目){24}","なうぇすと(横浜4日目〜,福井,福岡,宮城,愛知,静岡,大阪,北海道,広島){24}","なうぇすと(各会場オーラス){24}","なうぇすと(広島オーラス){24}","WESTival{19}","WESTival(各会場オーラス){19}","WESTival(北海道オーラス){19}","WESTV!{26}","WESTV!(各会場オーラス){26}","WESTV!(北海道オーラス){26}","W trouble12/12昼,12/13夜{22}","rainboW(北海道){27}",],
        singer: "WEST.",
        date: "2016-07-27",
        tiup: "読売テレビ・日本テレビ系アニメ『逆転裁判〜その「真実」、異議あり！〜』オープニングテーマ",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["パリピポ{17}","パリピポ(各会場オーラス){17}","パリピポ(兵庫オーラス){17}","24(ニシ)から感謝届けます♡{8}","24(ニシ)から感謝届けます♡(オーラス){8}",],
        singer: "WEST.",
        date: "2016-07-27",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["なうぇすと(〜横浜3日目){2}","なうぇすと(横浜4日目〜,福井,福岡,宮城,愛知,静岡,大阪,北海道,広島){2}","なうぇすと(各会場オーラス){2}","なうぇすと(広島オーラス){2}","W trouble12/11{3}","W trouble12/12昼,12/13夜{3}","W trouble12/12夜,12/13昼{3}","TO BE KANSAI COLOR-翔べ関西から-(大阪){25}","TO BE KANSAI COLOR-翔べ関西から-(名古屋){24}","TO BE KANSAI COLOR-翔べ関西から-(東京){22}","TO BE KANSAI COLOR-翔べ関西から-(東京オーラス){22}",],
        singer: "WEST.",
        date: "2016-11-30",
    ...
    },
    {
        ...
        album: ["なうぇすと","なうぇすと[初回盤]","なうぇすと[通常盤]"],
        announce: "t",
        performances: ["24(ニシ)から感謝届けます♡{14}","24(ニシ)から感謝届けます♡(オーラス){14}","W trouble12/11{19}",],
        singer: "WEST.",
        date: "2016-11-30",
    ...
    },
    {
        ...
        album: ["なうぇすと","なうぇすと[初回盤]","なうぇすと[通常盤]"],
        announce: "t",
        performances: ["なうぇすと(〜横浜3日目){10}","なうぇすと(横浜4日目〜,福井,福岡,宮城,愛知,静岡,大阪,北海道,広島){10}","なうぇすと(各会場オーラス){10}","なうぇすと(広島オーラス){10}","WESTival{26}","WESTival(各会場オーラス){26}","WESTival(北海道オーラス){26}",],
        singer: "WEST.",
        date: "2016-11-30",
    ...
    },
    {
        ...
        album: ["なうぇすと","なうぇすと[通常盤]"],
        announce: "t",
        performances: ["なうぇすと(〜横浜3日目){12}","なうぇすと(横浜4日目〜,福井,福岡,宮城,愛知,静岡,大阪,北海道,広島){12}","なうぇすと(各会場オーラス){12}","なうぇすと(広島オーラス){12}",],
        singer: "濵田崇裕＆小瀧望",
        date: "2016-11-30",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["24(ニシ)から感謝届けます♡{12}","24(ニシ)から感謝届けます♡(オーラス){12}",],
        singer: "WEST.",
        date: "2016-11-30",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["WESTival{1}","WESTival(各会場オーラス){1}","WESTival(北海道オーラス){1}","W trouble12/11{21}","Mixed Juice(静岡3/20,熊本3/26,宮城4/1,宮城4/2,愛知4/10,愛知4/15,横浜4/28,北海道6/10){24}","Mixed Juice(静岡3/21,熊本3/27,宮城4/3,愛知4/9,大阪4/16,大阪4/17,横浜4/27昼,横浜4/29昼,横浜4/30,城ホ5/5昼,新潟5/15昼,北海道6/11){24}","Mixed Juice(横浜4/27夜,横浜5/1夜,城ホ5/5夜,新潟5/15夜,北海道6/12夜){24}","Mixed Juice(横浜4/29夜,横浜5/1昼,城ホ5/4,新潟5/16,北海道6/12昼){24}","Mixed Juice(北海道オーラス){24}",],
        singer: "WEST.",
        date: "2017-06-21",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["WESTival{15}","WESTival(各会場オーラス){15}","WESTival(北海道オーラス){15}",],
        singer: "WEST.",
        date: "2017-06-21",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["WESTival{7}","WESTival(各会場オーラス){7}","WESTival(北海道オーラス){7}",],
        singer: "WEST.",
        date: "2017-11-22",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["WESTival{6}","WESTival(各会場オーラス){6}","WESTival(北海道オーラス){6}",],
        singer: "WEST.",
        date: "2017-11-22",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["WESTival{13}","WESTival(各会場オーラス){13}","WESTival(北海道オーラス){13}",],
        singer: "神山智洋＆濵田崇裕",
        date: "2018-01-02",
    ...
    },
    {
        ...
        album: ["WESTival","WESTival[通常盤]"],
        announce: "t",
        performances: ["WESTival{12}","WESTival(各会場オーラス){12}","WESTival(北海道オーラス){12}",],
        singer: "桐山照史＆重岡大毅",
        date: "2018-01-02",
        lyrics: "ガタンゴトン揺れる僕らは\n出会い別れまた恋をして\nドンと構えた僕の切符\n乗り越しラブストーリー\n\n「よっ」て言えよはよ\n車窓透けた僕赤ら顔\nこっち気づいてや\nキレイなってる横顔\n\nいつだって何だって繋いだ手と手\n「めっちゃ幸せ」言うて見つめ合った\n目を閉じて　思い出ひたっとったけど\nドア開く　まだ好きなんや\n\nガタンゴトン揺れる僕らは\nいったいどこへ向かってるの\nポケットつまづいた僕の切符\n乗り越しラブストーリー\n\n誕生日にくれた流行りのキャップ\n実はサイズ　きつい\n「私も一緒に使いたくって」\nってエヘヘちゃうで\n\n怒らせたくて　パシャリ寝顔\n「もうやめて～」って僕見つけてギュッ\nアダムとイヴも二度見しとったやろ\nドア開く　まだ降りないで\n\nガタンゴトン揺れる僕らは\nきっと笑うため泣いてたの\nポケットでぽけーっと僕の切符\n乗り越しラブストーリー\n\n僕を待つ君がもしいたら\nどんなに笑えんだろう\n本当は知ってた　サヨナラだって\n君の切符　幸せそう\n僕が降りる駅　見えてきたよ\n\nガタンゴトン揺れる僕らは\n出会い別れまた恋をして\nドンと構えた僕の切符\n乗り越しラブストーリー\n乗り越しラブストーリー\n乗り越しラブストーリー\n\n揺れる心　行け涙　僕の“愛してる”",
    },
    ...
    },
    {
        ...
        announce: "t",
        performances: ["WESTival{5}","WESTival(各会場オーラス){5}","WESTival(北海道オーラス){5}","WESTV!{12}","WESTV!(各会場オーラス){12}","WESTV!(北海道オーラス){12}","W trouble12/11{4}","W trouble12/12昼,12/13夜{4}","W trouble12/12夜,12/13昼{4}","rainboW(北海道){13}","rainboW(宮城,愛知,新潟,埼玉,熊本){13}","rainboW(円盤){13}","TO BE KANSAI COLOR-翔べ関西から-(大阪){9}","TO BE KANSAI COLOR-翔べ関西から-(名古屋){9}","TO BE KANSAI COLOR-翔べ関西から-(東京){9}","TO BE KANSAI COLOR-翔べ関西から-(東京オーラス){9}",],
        singer: "WEST.",
        date: "2018-03-07",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["WESTV!{24}","WESTV!(各会場オーラス){24}","WESTV!(北海道オーラス){24}",],
        singer: "WEST.",
        date: "2018-03-07",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["WESTV!{4}","WESTV!(各会場オーラス){4}","WESTV!(北海道オーラス){4}",],
        singer: "WEST.",
        date: "2018-08-15",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["WESTV!{21}","WESTV!(各会場オーラス){21}","WESTV!(北海道オーラス){21}","Mixed Juice(静岡3/20,熊本3/26,宮城4/1,宮城4/2,愛知4/10,愛知4/15,横浜4/28,北海道6/10){21}","Mixed Juice(静岡3/21,熊本3/27,宮城4/3,愛知4/9,大阪4/16,大阪4/17,横浜4/27昼,横浜4/29昼,横浜4/30,城ホ5/5昼,新潟5/15昼,北海道6/11){21}","Mixed Juice(横浜4/27夜,横浜5/1夜,城ホ5/5夜,新潟5/15夜,北海道6/12夜){21}","Mixed Juice(横浜4/29夜,横浜5/1昼,城ホ5/4,新潟5/16,北海道6/12昼){21}","Mixed Juice(北海道オーラス){21}","TO BE KANSAI COLOR-翔べ関西から-(大阪){22}","TO BE KANSAI COLOR-翔べ関西から-(名古屋){21}","TO BE KANSAI COLOR-翔べ関西から-(東京){19}","TO BE KANSAI COLOR-翔べ関西から-(東京オーラス){19}",],
        singer: "WEST.",
        date: "2018-12-05",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["WESTV!{17}","WESTV!(各会場オーラス){17}","WESTV!(北海道オーラス){17}",],
        singer: "中間淳太＆藤井流星",
        date: "2018-12-05",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["WESTV!{15}","WESTV!(各会場オーラス){15}","WESTV!(北海道オーラス){15}","W trouble12/12昼,12/13夜{23}","rainboW(北海道){4}","rainboW(宮城,愛知,新潟,埼玉,熊本){4}","rainboW(円盤){4}","Mixed Juice(静岡3/20,熊本3/26,宮城4/1,宮城4/2,愛知4/10,愛知4/15,横浜4/28,北海道6/10){27}","Mixed Juice(静岡3/21,熊本3/27,宮城4/3,愛知4/9,大阪4/16,大阪4/17,横浜4/27昼,横浜4/29昼,横浜4/30,城ホ5/5昼,新潟5/15昼,北海道6/11){27}","Mixed Juice(横浜4/27夜,横浜5/1夜,城ホ5/5夜,新潟5/15夜,北海道6/12夜){27}","Mixed Juice(横浜4/29夜,横浜5/1昼,城ホ5/4,新潟5/16,北海道6/12昼){27}","Mixed Juice(北海道オーラス){27}","TO BE KANSAI COLOR-翔べ関西から-(大阪){14}","TO BE KANSAI COLOR-翔べ関西から-(名古屋){35}","TO BE KANSAI COLOR-翔べ関西から-(東京){33}","TO BE KANSAI COLOR-翔べ関西から-(東京オーラス){33}",],
        singer: "WEST.",
        date: "2019-01-30",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["W trouble12/11{11}","W trouble12/12昼,12/13夜{11}","TO BE KANSAI COLOR-翔べ関西から-(大阪){35}","TO BE KANSAI COLOR-翔べ関西から-(名古屋){33}","TO BE KANSAI COLOR-翔べ関西から-(東京){34}","TO BE KANSAI COLOR-翔べ関西から-(東京オーラス){34}",],
        singer: "WEST.",
        date: "2019-04-24",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["W trouble12/11{24}","W trouble12/12昼,12/13夜{25}","W trouble12/12夜,12/13昼{25}","rainboW(北海道){2}","rainboW(宮城,愛知,新潟,埼玉,熊本){2}","rainboW(円盤){2}","Mixed Juice(静岡3/20,熊本3/26,宮城4/1,宮城4/2,愛知4/10,愛知4/15,横浜4/28,北海道6/10){7}","Mixed Juice(静岡3/21,熊本3/27,宮城4/3,愛知4/9,大阪4/16,大阪4/17,横浜4/27昼,横浜4/29昼,横浜4/30,城ホ5/5昼,新潟5/15昼,北海道6/11){7}","Mixed Juice(横浜4/27夜,横浜5/1夜,城ホ5/5夜,新潟5/15夜,北海道6/12夜){7}","Mixed Juice(横浜4/29夜,横浜5/1昼,城ホ5/4,新潟5/16,北海道6/12昼){7}","Mixed Juice(北海道オーラス){7}","TO BE KANSAI COLOR-翔べ関西から-(大阪){2}","TO BE KANSAI COLOR-翔べ関西から-(名古屋){2}","TO BE KANSAI COLOR-翔べ関西から-(東京){2}","TO BE KANSAI COLOR-翔べ関西から-(東京オーラス){2}",],
        singer: "WEST.",
        date: "2019-10-09",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["W trouble12/11{1}","W trouble12/12昼,12/13夜{1}","W trouble12/12夜,12/13昼{1}","Mixed Juice(静岡3/20,熊本3/26,宮城4/1,宮城4/2,愛知4/10,愛知4/15,横浜4/28,北海道6/10){20}","Mixed Juice(静岡3/21,熊本3/27,宮城4/3,愛知4/9,大阪4/16,大阪4/17,横浜4/27昼,横浜4/29昼,横浜4/30,城ホ5/5昼,新潟5/15昼,北海道6/11){20}","Mixed Juice(横浜4/27夜,横浜5/1夜,城ホ5/5夜,新潟5/15夜,北海道6/12夜){20}","Mixed Juice(横浜4/29夜,横浜5/1昼,城ホ5/4,新潟5/16,北海道6/12昼){20}","Mixed Juice(北海道オーラス){20}","TO BE KANSAI COLOR-翔べ関西から-(大阪){6}","TO BE KANSAI COLOR-翔べ関西から-(名古屋){6}","TO BE KANSAI COLOR-翔べ関西から-(東京){6}","TO BE KANSAI COLOR-翔べ関西から-(東京オーラス){6}",],
        singer: "WEST.",
        date: "2020-03-18",
    ...
    },
    {
        ...
        album: ["W trouble","W trouble[初回A]","W trouble[初回B]","W trouble[通常盤]","W trouble[通販盤]"],
        announce: "t",
        performances: ["W trouble12/11{9}","W trouble12/12昼,12/13夜{9}","W trouble12/12夜,12/13昼{9}",],
        singer: "WEST.",
        date: "2020-03-18",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["TO BE KANSAI COLOR-翔べ関西から-(大阪){16}","TO BE KANSAI COLOR-翔べ関西から-(名古屋){15}","TO BE KANSAI COLOR-翔べ関西から-(東京){16}","TO BE KANSAI COLOR-翔べ関西から-(東京オーラス){16}",],
        singer: "WEST.",
        date: "2020-06-24",
    ...
    },
    {
        ...
        album: ["証拠","証拠[初回B]","AWARD","AWARD[通常盤]"],
        announce: "t",
        performances: ["W trouble12/12夜,12/13昼{11}","TO BE KANSAI COLOR-翔べ関西から-(東京){13}","TO BE KANSAI COLOR-翔べ関西から-(東京オーラス){13}",],
        singer: "WEST.",
        date: "2020-06-24",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["W trouble12/11{12}","W trouble12/12昼,12/13夜{12}","W trouble12/12夜,12/13昼{12}","rainboW(北海道){28}","rainboW(宮城,愛知,新潟,埼玉,熊本){28}","rainboW(円盤){28}","Mixed Juice(静岡3/20,熊本3/26,宮城4/1,宮城4/2,愛知4/10,愛知4/15,横浜4/28,北海道6/10){13}","Mixed Juice(静岡3/21,熊本3/27,宮城4/3,愛知4/9,大阪4/16,大阪4/17,横浜4/27昼,横浜4/29昼,横浜4/30,城ホ5/5昼,新潟5/15昼,北海道6/11){13}","Mixed Juice(横浜4/27夜,横浜5/1夜,城ホ5/5夜,新潟5/15夜,北海道6/12夜){13}","Mixed Juice(横浜4/29夜,横浜5/1昼,城ホ5/4,新潟5/16,北海道6/12昼){13}","Mixed Juice(北海道オーラス){13}","TO BE KANSAI COLOR-翔べ関西から-(大阪){29}","TO BE KANSAI COLOR-翔べ関西から-(名古屋){13}","TO BE KANSAI COLOR-翔べ関西から-(東京){14}","TO BE KANSAI COLOR-翔べ関西から-(東京オーラス){14}",],
        singer: "WEST.",
        date: "2021-01-13",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["rainboW(北海道){5}","rainboW(宮城,愛知,新潟,埼玉,熊本){5}","rainboW(円盤){5}",],
        singer: "WEST.",
        date: "2021-01-13",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["rainboW(北海道){22}","rainboW(宮城,愛知,新潟,埼玉,熊本){22}","rainboW(円盤){22}",],
        singer: "WEST.",
        date: "2021-03-17",
    ...
    },
    {
        ...
        album: ["rainboW","rainboW[初回A]","rainboW[初回B]","rainboW[通常盤]","rainboW[通販盤]"],
        announce: "t",
        performances: ["rainboW(北海道){12}","rainboW(宮城,愛知,新潟,埼玉,熊本){12}","rainboW(円盤){12}",],
        singer: "WEST.",
        date: "2021-03-17",
    ...
    },
    {
        ...
        album: ["rainboW","rainboW[初回A]","rainboW[初回B]","rainboW[通常盤]","rainboW[通販盤]"],
        announce: "t",
        performances: ["rainboW(北海道){3}","rainboW(宮城,愛知,新潟,埼玉,熊本){3}","rainboW(円盤){3}",],
        singer: "WEST.",
        date: "2021-03-17",
    ...
    },
    {
        ...
        album: ["rainboW","rainboW[通常盤]","rainboW[通販盤]"],
        announce: "t",
        performances: ["rainboW(北海道){18}","rainboW(宮城,愛知,新潟,埼玉,熊本){18}","rainboW(円盤){18}",],
        singer: "WEST.",
        date: "2021-03-17",
    ...
    },
    {
        ...
        album: ["rainboW","rainboW[初回A]","rainboW[初回B]","rainboW[通常盤]","rainboW[通販盤]"],
        announce: "t",
        performances: ["rainboW(北海道){29}","rainboW(宮城,愛知,新潟,埼玉,熊本){29}","rainboW(円盤){29}",],
        singer: "WEST.",
        date: "2021-03-17",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["rainboW(北海道){19}","rainboW(宮城,愛知,新潟,埼玉,熊本){19}","rainboW(円盤){19}",],
        singer: "WEST.",
        date: "2021-03-17",
        lyrics: "貼り付けられたレッテル\n決めつけないで\n未来(あす)のポシビリティー\nその目を離した隙に変わってゆくんだろ\n時代も人も全部\n\n懐かしい日々　語り合うのも\n別に悪いことじゃないけど\nねぇ？\n見てよ最新版\n\nOh\n革新論理\n1秒後にどうなってるかわからない\nこんな世界に僕ら生きているんだ\nOh baby\n寄り添ったって　噛み付いたって\n100点なんか取れやしない\nずっと今を正解にしていくんだ\nだったらいっそ　大胆に更新\n人の目ばっか　気にしてもしゃあないし\n\n書き殴られた声明\n目を逸らしても消えないディスプレイ\n「そんなに悪いことかい？」\n無邪気な表情で問いかけてくる\n\n安心感にすがってばかり\n別にまあどうでもいいけど\nねぇ？\n邪魔はしないで\n\nOh\n革新論理\n1秒後にどうなってるかわからない\nこんな世界に僕ら生きているんだ\nOh baby\n賛否両論　飛び交う論争\nどれを選んでもそうでしょ？\nそんで　現状維持は実質退化\n何回だって　大胆に更新\n諸行無常が　きっとこの世の心理\n\n止まれない　止まれない　どうしても\n一体何に追われてる？\n答えもあやふやなままに\n生きるとは　変わり続けることだ\nUpdate only　止まらない\n\nOh\n革新論理\n1秒後にどうなってるかわからない\nこんな世界に僕ら生きているんだ\nOh baby\n寄り添ったって　噛み付いたって\n100点なんか取れやしない\nずっと今を正解にしていくんだ\nだったらいっそ　大胆に更新\n人の目ばっか　気にしてもしゃあないし\n\n繰り返しばっか　退屈なんだ\nいつだって　刺激を欲しがってるんだ\n何回だって　大胆に更新\n諸行無常が　きっとこの世の心理",
    },
    ...
    },
    {
        ...
        announce: "t",
        performances: ["Mixed Juice(静岡3/20,熊本3/26,宮城4/1,宮城4/2,愛知4/10,愛知4/15,横浜4/28,北海道6/10){29}","Mixed Juice(静岡3/21,熊本3/27,宮城4/3,愛知4/9,大阪4/16,大阪4/17,横浜4/27昼,横浜4/29昼,横浜4/30,城ホ5/5昼,新潟5/15昼,北海道6/11){29}","Mixed Juice(横浜4/27夜,横浜5/1夜,城ホ5/5夜,新潟5/15夜,北海道6/12夜){29}","Mixed Juice(横浜4/29夜,横浜5/1昼,城ホ5/4,新潟5/16,北海道6/12昼){29}","Mixed Juice(北海道オーラス){29}","TO BE KANSAI COLOR-翔べ関西から-(大阪){31}","TO BE KANSAI COLOR-翔べ関西から-(名古屋){29}","TO BE KANSAI COLOR-翔べ関西から-(東京){27}","TO BE KANSAI COLOR-翔べ関西から-(東京オーラス){27}",],
        singer: "WEST.",
        date: "2021-05-05",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["TO BE KANSAI COLOR-翔べ関西から-(大阪){10}","TO BE KANSAI COLOR-翔べ関西から-(名古屋){10}","TO BE KANSAI COLOR-翔べ関西から-(東京){10}","TO BE KANSAI COLOR-翔べ関西から-(東京オーラス){10}",],
        singer: "WEST.",
        date: "2021-05-05",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["Mixed Juice(静岡3/20,熊本3/26,宮城4/1,宮城4/2,愛知4/10,愛知4/15,横浜4/28,北海道6/10){30}","Mixed Juice(静岡3/21,熊本3/27,宮城4/3,愛知4/9,大阪4/16,大阪4/17,横浜4/27昼,横浜4/29昼,横浜4/30,城ホ5/5昼,新潟5/15昼,北海道6/11){30}","Mixed Juice(横浜4/27夜,横浜5/1夜,城ホ5/5夜,新潟5/15夜,北海道6/12夜){30}","Mixed Juice(横浜4/29夜,横浜5/1昼,城ホ5/4,新潟5/16,北海道6/12昼){30}","Mixed Juice(北海道オーラス){30}","TO BE KANSAI COLOR-翔べ関西から-(大阪){32}","TO BE KANSAI COLOR-翔べ関西から-(名古屋){30}","TO BE KANSAI COLOR-翔べ関西から-(東京){28}","TO BE KANSAI COLOR-翔べ関西から-(東京オーラス){28}",],
        singer: "WEST.",
        date: "2021-05-05",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["Mixed Juice(静岡3/20,熊本3/26,宮城4/1,宮城4/2,愛知4/10,愛知4/15,横浜4/28,北海道6/10){12}","Mixed Juice(静岡3/21,熊本3/27,宮城4/3,愛知4/9,大阪4/16,大阪4/17,横浜4/27昼,横浜4/29昼,横浜4/30,城ホ5/5昼,新潟5/15昼,北海道6/11){12}","Mixed Juice(横浜4/27夜,横浜5/1夜,城ホ5/5夜,新潟5/15夜,北海道6/12夜){12}","Mixed Juice(横浜4/29夜,横浜5/1昼,城ホ5/4,新潟5/16,北海道6/12昼){12}","Mixed Juice(北海道オーラス){12}","TO BE KANSAI COLOR-翔べ関西から-(大阪){18}","TO BE KANSAI COLOR-翔べ関西から-(名古屋){17}","TO BE KANSAI COLOR-翔べ関西から-(東京){18}","TO BE KANSAI COLOR-翔べ関西から-(東京オーラス){18}",],
        singer: "WEST.",
        date: "2021-07-28",
    ...
    },
    {
        ...
        album: ["でっかい愛/喜努愛楽","でっかい愛/喜努愛楽[初回A]","でっかい愛/喜努愛楽[初回B]","でっかい愛/喜努愛楽[通常盤]","Mixed Juice","Mixed Juice[初回A]","Mixed Juice[初回B]","Mixed Juice[通常盤]","AWARD","AWARD[初回A]","AWARD[初回B]","AWARD[通常盤]"],
        announce: "t",
        performances: ["Mixed Juice(静岡3/20,熊本3/26,宮城4/1,宮城4/2,愛知4/10,愛知4/15,横浜4/28,北海道6/10){14}","Mixed Juice(静岡3/21,熊本3/27,宮城4/3,愛知4/9,大阪4/16,大阪4/17,横浜4/27昼,横浜4/29昼,横浜4/30,城ホ5/5昼,新潟5/15昼,北海道6/11){14}","Mixed Juice(横浜4/27夜,横浜5/1夜,城ホ5/5夜,新潟5/15夜,北海道6/12夜){14}","Mixed Juice(横浜4/29夜,横浜5/1昼,城ホ5/4,新潟5/16,北海道6/12昼){14}","Mixed Juice(北海道オーラス){14}",],
        singer: "WEST.",
        date: "2021-07-28",
    ...
    },
    {
        ...
        album: ["黎明/進むしかねぇ","黎明/進むしかねぇ[初回A]","黎明/進むしかねぇ[初回B]","黎明/進むしかねぇ[通常盤]","Mixed Juice","Mixed Juice[初回A]","Mixed Juice[初回B]","Mixed Juice[通常盤]","AWARD","AWARD[初回A]","AWARD[初回B]","AWARD[通常盤]"],
        announce: "t",
        performances: ["Mixed Juice(静岡3/20,熊本3/26,宮城4/1,宮城4/2,愛知4/10,愛知4/15,横浜4/28,北海道6/10){33}","Mixed Juice(静岡3/21,熊本3/27,宮城4/3,愛知4/9,大阪4/16,大阪4/17,横浜4/27昼,横浜4/29昼,横浜4/30,城ホ5/5昼,新潟5/15昼,北海道6/11){33}","Mixed Juice(横浜4/27夜,横浜5/1夜,城ホ5/5夜,新潟5/15夜,北海道6/12夜){33}","Mixed Juice(横浜4/29夜,横浜5/1昼,城ホ5/4,新潟5/16,北海道6/12昼){33}","Mixed Juice(北海道オーラス){33}",],
        singer: "WEST.",
        date: "2022-01-19",
    ...
    },
    {
        ...
        album: ["Mixed Juice","Mixed Juice[初回A]","Mixed Juice[初回B]","Mixed Juice[通常盤]"],
        announce: "t",
        performances: ["Mixed Juice(静岡3/20,熊本3/26,宮城4/1,宮城4/2,愛知4/10,愛知4/15,横浜4/28,北海道6/10){32}","Mixed Juice(静岡3/21,熊本3/27,宮城4/3,愛知4/9,大阪4/16,大阪4/17,横浜4/27昼,横浜4/29昼,横浜4/30,城ホ5/5昼,新潟5/15昼,北海道6/11){32}","Mixed Juice(横浜4/27夜,横浜5/1夜,城ホ5/5夜,新潟5/15夜,北海道6/12夜){32}","Mixed Juice(横浜4/29夜,横浜5/1昼,城ホ5/4,新潟5/16,北海道6/12昼){32}","Mixed Juice(北海道オーラス){32}","TO BE KANSAI COLOR-翔べ関西から-(大阪){12}","TO BE KANSAI COLOR-翔べ関西から-(名古屋){12}","TO BE KANSAI COLOR-翔べ関西から-(東京){12}","TO BE KANSAI COLOR-翔べ関西から-(東京オーラス){12}",],
        singer: "WEST.",
        date: "2022-03-09",
    ...
    },
    {
        ...
        album: ["Mixed Juice","Mixed Juice[初回A]","Mixed Juice[初回B]","Mixed Juice[通常盤]"],
        announce: "t",
        performances: ["Mixed Juice(静岡3/20,熊本3/26,宮城4/1,宮城4/2,愛知4/10,愛知4/15,横浜4/28,北海道6/10){15}","Mixed Juice(静岡3/21,熊本3/27,宮城4/3,愛知4/9,大阪4/16,大阪4/17,横浜4/27昼,横浜4/29昼,横浜4/30,城ホ5/5昼,新潟5/15昼,北海道6/11){15}","Mixed Juice(横浜4/27夜,横浜5/1夜,城ホ5/5夜,新潟5/15夜,北海道6/12夜){15}","Mixed Juice(横浜4/29夜,横浜5/1昼,城ホ5/4,新潟5/16,北海道6/12昼){15}","Mixed Juice(北海道オーラス){15}",],
        singer: "WEST.",
        date: "2022-03-09",
    ...
    },
    {
        ...
        album: ["Mixed Juice","Mixed Juice[初回A]","Mixed Juice[初回B]","Mixed Juice[通常盤]"],
        announce: "t",
        performances: ["Mixed Juice(静岡3/20,熊本3/26,宮城4/1,宮城4/2,愛知4/10,愛知4/15,横浜4/28,北海道6/10){5}","Mixed Juice(静岡3/21,熊本3/27,宮城4/3,愛知4/9,大阪4/16,大阪4/17,横浜4/27昼,横浜4/29昼,横浜4/30,城ホ5/5昼,新潟5/15昼,北海道6/11){5}","Mixed Juice(横浜4/27夜,横浜5/1夜,城ホ5/5夜,新潟5/15夜,北海道6/12夜){5}","Mixed Juice(横浜4/29夜,横浜5/1昼,城ホ5/4,新潟5/16,北海道6/12昼){5}","Mixed Juice(北海道オーラス){5}",],
        singer: "WEST.",
        date: "2022-03-09",
    ...
    },
    {
        ...
        album: ["Mixed Juice","Mixed Juice[初回A]","Mixed Juice[初回B]","Mixed Juice[通常盤]"],
        announce: "t",
        performances: ["Mixed Juice(静岡3/20,熊本3/26,宮城4/1,宮城4/2,愛知4/10,愛知4/15,横浜4/28,北海道6/10){17}","Mixed Juice(静岡3/21,熊本3/27,宮城4/3,愛知4/9,大阪4/16,大阪4/17,横浜4/27昼,横浜4/29昼,横浜4/30,城ホ5/5昼,新潟5/15昼,北海道6/11){17}","Mixed Juice(横浜4/27夜,横浜5/1夜,城ホ5/5夜,新潟5/15夜,北海道6/12夜){17}","Mixed Juice(横浜4/29夜,横浜5/1昼,城ホ5/4,新潟5/16,北海道6/12昼){17}","Mixed Juice(北海道オーラス){17}",],
        singer: "WEST.",
        date: "2022-03-09",
    ...
    },
    {
        ...
        album: ["Mixed Juice","Mixed Juice[初回A]","Mixed Juice[初回B]","Mixed Juice[通常盤]"],
        announce: "t",
        performances: ["Mixed Juice(北海道オーラス){35}",],
        singer: "WEST.",
        date: "2022-03-09",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["Mixed Juice(静岡3/20,熊本3/26,宮城4/1,宮城4/2,愛知4/10,愛知4/15,横浜4/28,北海道6/10){6}","Mixed Juice(静岡3/21,熊本3/27,宮城4/3,愛知4/9,大阪4/16,大阪4/17,横浜4/27昼,横浜4/29昼,横浜4/30,城ホ5/5昼,新潟5/15昼,北海道6/11){6}","Mixed Juice(横浜4/27夜,横浜5/1夜,城ホ5/5夜,新潟5/15夜,北海道6/12夜){6}","Mixed Juice(横浜4/29夜,横浜5/1昼,城ホ5/4,新潟5/16,北海道6/12昼){6}","Mixed Juice(北海道オーラス){6}",],
        singer: "WEST.",
        date: "2022-03-09",
