export const songs = [
    { 
        ...
        announce: "t",
        performances:["なにわともあれ、ほんまにありがとう！{1}","なにわともあれ、ほんまにありがとう！{14}","一発めぇぇぇぇぇぇぇ！{1}","一発めぇぇぇぇぇぇぇ！(各会場オーラス){1}","一発めぇぇぇぇぇぇぇ！(各会場オーラス){20}","一発めぇぇぇぇぇぇぇ！(大阪オーラス){1}","一発めぇぇぇぇぇぇぇ！(大阪オーラス){20}","パリピポ{12}","パリピポ(兵庫オーラス){12}","ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟){2}",],
        singer: "WEST.",
        date: "2014-04-23",
    ...
    {          
        ...
        announce: "t",
        performances:["なにわともあれ、ほんまにありがとう！{4}","一発めぇぇぇぇぇぇぇ！{8}","一発めぇぇぇぇぇぇぇ！(各会場オーラス){8}","一発めぇぇぇぇぇぇぇ！(大阪オーラス){8}","パリピポ(兵庫オーラス){26}",],
        singer: "WEST.",
        date: "2014-04-23",
    ...
    },
    {
        ...
        announce: "t",
        performances:["なにわともあれ、ほんまにありがとう！{3}","一発めぇぇぇぇぇぇぇ！{13}","一発めぇぇぇぇぇぇぇ！(各会場オーラス){13}","一発めぇぇぇぇぇぇぇ！(大阪オーラス){13}",],
        singer: "WEST.",
        date: "2014-04-23",
    ...
    },
    {
        ...
        album: ["ええじゃないか","ええじゃないか[通常盤]","go WEST よーいドン！","go WEST よーいドン！[初回盤]","go WEST よーいドン！[通常盤]"],
        announce: "t",
        performances:["なにわともあれ、ほんまにありがとう！{2}","一発めぇぇぇぇぇぇぇ！{17}","一発めぇぇぇぇぇぇぇ！(各会場オーラス){17}","一発めぇぇぇぇぇぇぇ！(大阪オーラス){17}","パリピポ{11}","パリピポ(兵庫オーラス){11}","ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟){13}",],
        singer: "WEST.",
        date: "2014-04-23",
    ...
    },
    {
        ...
        announce: "t",
        performances:["なにわともあれ、ほんまにありがとう！{13}","一発めぇぇぇぇぇぇぇ！{18}","一発めぇぇぇぇぇぇぇ！(各会場オーラス){18}","一発めぇぇぇぇぇぇぇ！(大阪オーラス){18}","パリピポ{13}","パリピポ(兵庫オーラス){13}",],
        singer: "WEST.",
        date: "2014-04-23",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["一発めぇぇぇぇぇぇぇ！{4}","一発めぇぇぇぇぇぇぇ！(各会場オーラス){4}","一発めぇぇぇぇぇぇぇ！(大阪オーラス){4}","パリピポ{15}","パリピポ(兵庫オーラス){15}",],
        singer: "WEST.",
        date: "2014-08-06",
    ...
    },
    {
        ...
        album: ["go WEST よーいドン！","go WEST よーいドン！[初回盤]","go WEST よーいドン！[通常盤]"],
        announce: "t",
        performances:["なにわともあれ、ほんまにありがとう！{5}","一発めぇぇぇぇぇぇぇ！{3}","一発めぇぇぇぇぇぇぇ！(各会場オーラス){3}","一発めぇぇぇぇぇぇぇ！(大阪オーラス){3}","パリピポ{9}","パリピポ(兵庫オーラス){9}","ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟){19}",],
        singer: "WEST.",
        date: "2014-08-06",
    ...
    },
    {
        ...
        announce: "t",
        performances:["なにわともあれ、ほんまにありがとう！{7}","パリピポ{25}","パリピポ(兵庫オーラス){25}","ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟){10}",],
        singer: "WEST.",
        date: "2014-08-06",
    ...
    },
    {
        ...
        album: ["go WEST よーいドン！","go WEST よーいドン！[初回盤]","go WEST よーいドン！[通常盤]"],
        announce: "t",
        performances:["なにわともあれ、ほんまにありがとう！{11}","一発めぇぇぇぇぇぇぇ！{15}","一発めぇぇぇぇぇぇぇ！(各会場オーラス){15}","一発めぇぇぇぇぇぇぇ！(大阪オーラス){15}","パリピポ{16}","パリピポ(兵庫オーラス){16}",],
        singer: "WEST.",
        date: "2014-08-06",
    ...
    },
    {
        ...
        album: ["go WEST よーいドン！","go WEST よーいドン！[初回盤]","go WEST よーいドン！[通常盤]"],
        announce: "t",
        performances:["なにわともあれ、ほんまにありがとう！{12}","一発めぇぇぇぇぇぇぇ！{16}","一発めぇぇぇぇぇぇぇ！(各会場オーラス){16}","一発めぇぇぇぇぇぇぇ！(大阪オーラス){16}","パリピポ{23}","パリピポ(兵庫オーラス){23}","ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟){3}",],
        singer: "WEST.",
        date: "2014-08-06",
    ...
    },
    {
        ...
        album: ["go WEST よーいドン！","go WEST よーいドン！[通常盤]"],
        announce: "t",
        performances: ["一発めぇぇぇぇぇぇぇ！{19}","一発めぇぇぇぇぇぇぇ！(各会場オーラス){19}","一発めぇぇぇぇぇぇぇ！(大阪オーラス){19}","ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟){12}",],
        singer: "WEST.",
        date: "2014-08-06",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["一発めぇぇぇぇぇぇぇ！{2}","一発めぇぇぇぇぇぇぇ！(各会場オーラス){2}","一発めぇぇぇぇぇぇぇ！(大阪オーラス){2}","一発めぇぇぇぇぇぇぇ！(大阪オーラス){21}","パリピポ{3}","パリピポ(兵庫オーラス){3}","ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟){26}",],
        singer: "WEST.",
        date: "2014-10-08",
    ...
    },
    {
        ...
        album: ["ジパング・おおきに大作戦/夢を抱きしめて","ジパング・おおきに大作戦/夢を抱きしめて[初回A]","ジパング・おおきに大作戦/夢を抱きしめて[初回B]","ジパング・おおきに大作戦/夢を抱きしめて[初回C]","ジパング・おおきに大作戦/夢を抱きしめて[通常盤]","ラッキィィィィィィィ7","ラッキィィィィィィィ7[初回盤]","ラッキィィィィィィィ7[通常盤]","AWARD","AWARD[初回A]","AWARD[初回B]","AWARD[通常盤]"],
        announce: "t",
        performances: ["一発めぇぇぇぇぇぇぇ！{11}","一発めぇぇぇぇぇぇぇ！(各会場オーラス){11}","一発めぇぇぇぇぇぇぇ！(大阪オーラス){11}","パリピポ{5}","パリピポ(兵庫オーラス){5}",],
        singer: "WEST.",
        date: "2014-10-08",
    ...
    },
    {
        ...
        album: ["ジパング・おおきに大作戦/夢を抱きしめて","ジパング・おおきに大作戦/夢を抱きしめて[初回C]"],
        announce: "t",
        performances: ["一発めぇぇぇぇぇぇぇ！{6}","一発めぇぇぇぇぇぇぇ！(各会場オーラス){6}","一発めぇぇぇぇぇぇぇ！(大阪オーラス){6}","パリピポ{7}","パリピポ(兵庫オーラス){7}",],
        singer: "WEST.",
        date: "2014-10-08",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["一発めぇぇぇぇぇぇぇ！{14}","一発めぇぇぇぇぇぇぇ！(各会場オーラス){14}","一発めぇぇぇぇぇぇぇ！(大阪オーラス){14}","パリピポ{14}","パリピポ(兵庫オーラス){14}",],
        singer: "WEST.",
        date: "2014-10-08",
    ...
    },
    {
        ...
        album: ["ジパング・おおきに大作戦/夢を抱きしめて","ジパング・おおきに大作戦/夢を抱きしめて[通常盤]"],
        announce: "t",
        performances: ["パリピポ{22}","パリピポ(兵庫オーラス){22}",],
        singer: "WEST.",
        date: "2014-10-08",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["一発めぇぇぇぇぇぇぇ！{9}","一発めぇぇぇぇぇぇぇ！(各会場オーラス){9}","一発めぇぇぇぇぇぇぇ！(大阪オーラス){9}","パリピポ{2}","パリピポ(兵庫オーラス){2}","ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟){23}",],
        singer: "WEST.",
        date: "2015-02-04",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["パリピポ{20}","パリピポ(兵庫オーラス){20}",],
        singer: "WEST.",
        date: "2015-02-04",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["パリピポ{1}","パリピポ(兵庫オーラス){1}","ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟){11}",],
        singer: "WEST.",
        date: "2015-02-04",
    ...
    },
    {
        ...
        album: ["ズンドコ パラダイス","ズンドコ パラダイス[通常盤]"],
        announce: "t",
        performances: ["パリピポ{24}","パリピポ(兵庫オーラス){24}",],
        singer: "WEST.",
        date: "2015-02-04",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["パリピポ{4}","パリピポ(兵庫オーラス){4}","ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟){15}",],
        singer: "WEST.",
        date: "2015-04-22",
    ...
    },
    {
        ...
        album: ["パリピポ","パリピポ[初回盤]","パリピポ[通常盤]"],
        announce: "t",
        performances: ["パリピポ{19}","パリピポ(兵庫オーラス){19}",],
        singer: "WEST.",
        date: "2015-04-22",
    ...
    },
    {
        ...
        album: ["パリピポ","パリピポ[初回盤]","パリピポ[通常盤]"],
        announce: "t",
        performances: ["パリピポ{18}","パリピポ(兵庫オーラス){18}",],
        singer: "WEST.",
        date: "2015-04-22",
    ...
    },
    {
        ...
        album: ["パリピポ","パリピポ[初回盤]","パリピポ[通常盤]"],
        announce: "t",
        performances: ["パリピポ{6}","パリピポ(兵庫オーラス){6}",],
        singer: "WEST.",
        date: "2015-04-22",
    ...
    },
    {
        ...
        album: ["パリピポ","パリピポ[初回盤]","パリピポ[通常盤]"],
        announce: "t",
        performances: ["パリピポ{10}","パリピポ(兵庫オーラス){10}","ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟){14}",],
        singer: "WEST.",
        date: "2015-04-22",
    ...
    },
    {
        ...
        album: ["パリピポ","パリピポ[通常盤]"],
        announce: "t",
        performances: ["パリピポ{8}","パリピポ(兵庫オーラス){8}",],
        singer: "WEST.",
        date: "2015-04-22",
    ...
    },
    {
        ...
        album: ["パリピポ","パリピポ[通常盤]"],
        announce: "t",
        performances: ["パリピポ{21}","パリピポ(兵庫オーラス){21}","ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟){6}",],
        singer: "WEST.",
        date: "2015-04-22",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟){9}",],
        singer: "WEST.",
        date: "2015-07-29",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟){24}",],
        singer: "WEST.",
        date: "2015-07-29",
    ...
    },
    {
        ...
        album: ["バリ ハピ","バリ ハピ[通常盤]"],
        announce: "t",
        performances: ["ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟){5}",],
        singer: "WEST.",
        date: "2015-07-29",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟){1}",],
        singer: "WEST.",
        date: "2015-12-09",
    ...
    },
    {
        ...
        album: ["ラッキィィィィィィィ7","ラッキィィィィィィィ7[初回盤]","ラッキィィィィィィィ7[通常盤]"],
        announce: "t",
        performances: ["ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟){8}",],
        singer: "WEST.",
        date: "2015-12-09",
    ...
    },
    {
        ...
        album: ["ラッキィィィィィィィ7","ラッキィィィィィィィ7[初回盤]","ラッキィィィィィィィ7[通常盤]"],
        announce: "t",
        performances: ["ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟){20}",],
        singer: "WEST.",
        date: "2015-12-09",
    ...
    },
    {
        ...
        album: ["ラッキィィィィィィィ7","ラッキィィィィィィィ7[初回盤]","ラッキィィィィィィィ7[通常盤]"],
        announce: "t",
        performances: ["ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟){25}",],
        singer: "WEST.",
        date: "2015-12-09",
    ...
    },
    {
        ...
        album: ["ラッキィィィィィィィ7","ラッキィィィィィィィ7[初回盤]","ラッキィィィィィィィ7[通常盤]"],
        announce: "t",
        performances: ["ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟){18}",],
        singer: "WEST.",
        date: "2015-12-09",
        lyrics: "さぁ一緒行こう 3.14\n\n314 159 2653 589\n793 238 4626 433\n\n3.141592\nさぁ今皆で円になり\nScreaming Yeah！！\nJumping Yeah！！\n終わらないない Party！！Party！！\n\n僕らで手をとりゃEternity\n皆まで言わずに盛り上がり\n\nThree One Four！！\nThree One Four！！\nEndless Number\nLike a We are！！\n\n角張ってちゃロンリーナ\n意地張ってちゃメンドイナ\n落ち込んでちゃπになれねぇ\nWAになれ！！\n\nまんまる笑顔 3.14\n君の瞳は 3.14\n\n届け 3.1415926535\nどこまでも続く地平線\n繋がっているんだ\nほら一人じゃないんだ\n3.1415926535\nこの先が知りたいなら\n進みだすんだ\nさぁ！一緒行こう！3.1415\n\n314 159 2653 589\n793 238 4626 433\n良いこと嫌なこと\n沢山DAYS！！\nマイナス要素は\n四捨五入して\n切り捨て　切り替え\n前向いてやるしかねぇ！！\n進むしかねぇ！！\nsin, cos, tan\nよりかも大事な三大要素\nまず根性！！ 次　友情！！\n決め手は才能？ NO！NO！直感！！\n\nひねくれてちゃロンリーナ\nべそかいてちゃメンドイナ\n俯いてちゃπになれん\nWAになれ！！\n\n溢れる涙 3.14\n拭える強さ 3.14\n\n響け 3.1415926535\nどこにいても同じ夕焼け\n繋がっているんだ\nほら一人じゃないんだ\n3.1415926535\nこの先が知りたいから\n進みだすんだ\nさぁ！一緒いこう！3.1415\n\n全員、整列ー！「ハイ！」\n前ならえ！「ハイ！」\nなおれ！回れ右！\n1 2 サンキュー！\n前すすめ！\n全体止まれ！「イチ！ニ！」\n着席！起立！\n礼！よくできました☆\n\nまわる世界は3.14\n手を取り合えば3.14\n\n届け 3.1415926535\nどこまでも続く地平線\n繋がっているんだ\nほら一人じゃないんだ\n3.1415926535\nこの先が知りたいなら\n進みだすんだ\nさぁ！一緒行こう！3.1415",
    },
    {
        ...
        album: ["ラッキィィィィィィィ7","ラッキィィィィィィィ7[初回盤]","ラッキィィィィィィィ7[通常盤]"],
        announce: "t",
        performances: ["ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟){7}",],
        singer: "WEST.",
        date: "2015-12-09",
    ...
    },
    {
        ...
        album: ["ラッキィィィィィィィ7","ラッキィィィィィィィ7[初回盤]","ラッキィィィィィィィ7[通常盤]"],
        announce: "t",
        performances: ["ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟){22}",],
        singer: "WEST.",
        date: "2015-12-09",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟){21}",],
        singer: "中間淳太",
        date: "2015-12-09",
    ...
    },
    {
        ...
        album: ["ラッキィィィィィィィ7","ラッキィィィィィィィ7[通常盤]"],
        announce: "t",
        performances: ["ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟){16}",],
        singer: "重岡大毅＆神山智洋",
        date: "2015-12-09",
    ...
    { 
        ...
        album: ["ラッキィィィィィィィ7","ラッキィィィィィィィ7[通常盤]"],
        announce: "t",
        performances: ["ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟){4}",],
        singer: "藤井流星＆小瀧望",
        date: "2015-12-09",
    ...
    },
    {
        ...
        album: ["ラッキィィィィィィィ7","ラッキィィィィィィィ7[通常盤]"],
        announce: "t",
        performances: ["ラッキィィィィィィィ7(大阪,横浜,愛知,広島,福岡,新潟){17}",],
        singer: "桐山照史＆濵田崇裕",
        date: "2015-12-09",
    ...
    },
    {
        ...
        announce: "t",
        performances: ["パリピポ{17}","パリピポ(兵庫オーラス){17}",],
        singer: "WEST.",
        date: "2016-07-27",
